// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0047.litmus
...
label_2:;
  ...
  int v17_r10 = atomic_load_explicit(&vars[3+v14_r9], memory_order_acquire);
