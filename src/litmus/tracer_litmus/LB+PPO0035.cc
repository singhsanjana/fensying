// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0035.litmus
...
label_2:;
  ...
  int v18_r10 = atomic_load_explicit(&vars[3+v15_r9], memory_order_acquire);
