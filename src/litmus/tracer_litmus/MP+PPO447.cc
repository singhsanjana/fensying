// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO447.litmus
...
lbl_LC00:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v19_r12 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(&atom_1_r12_0, memory_order_acquire);
