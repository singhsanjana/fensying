// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/3.2W+lwsync+lwsync+rfi-data.litmus
...
label_3:;
  ...
  int v15 = (v2_r3 == 2);
  atomic_store_explicit(&atom_2_r3_2, v15, memory_order_release);
