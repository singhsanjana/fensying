// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO276.litmus
...
lbl_LC00:;
  ...
  int v15_r11 = atomic_load_explicit(&vars[4+v12_r10], memory_order_acquire);
