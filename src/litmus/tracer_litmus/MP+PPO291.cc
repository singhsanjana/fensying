// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO291.litmus
...
label_2:;
  ...
  atomic_store_explicit(&vars[4+v13_r10], 1, memory_order_release);
  int v15_r13 = atomic_load_explicit(&vars[4], memory_order_acquire);
...
lbl_LC00:;
  ...
  int v23 = (v18_r14 == 0);
  atomic_store_explicit(&atom_1_r14_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(&atom_1_r14_0, memory_order_acquire);
