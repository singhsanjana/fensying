// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0011.litmus
...
label_2:;
  ...
  int v20_r11 = atomic_load_explicit(&vars[4+v17_r10], memory_order_acquire);
