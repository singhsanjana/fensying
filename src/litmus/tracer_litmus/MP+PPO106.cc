// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO106.litmus
...
label_2:;
  ...
  int v6_r5 = v5_r5 + 1;
  atomic_store_explicit(&vars[2], v6_r5, memory_order_release);
  ...
  int v12_r10 = atomic_load_explicit(&vars[0+v9_r9], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v22, memory_order_release);
  int v23 = (v12_r10 == 0);
  atomic_store_explicit(&atom_1_r10_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(&atom_1_r10_0, memory_order_acquire);
