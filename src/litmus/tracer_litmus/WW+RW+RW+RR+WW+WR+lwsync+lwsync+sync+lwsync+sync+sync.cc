...
label_4:;
  ...
  int v26 = (v8_r3 == 0);
  atomic_store_explicit(&atom_3_r3_0, v26, memory_order_release);
...
void t5(void *arg){
label_6:;
  atomic_store_explicit(&vars[5], 2, memory_order_release);
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(&vars[5], memory_order_acquire);
  int v12 = (v11 == 2);
