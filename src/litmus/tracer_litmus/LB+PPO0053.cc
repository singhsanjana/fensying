// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0053.litmus
...
lbl_LC00:;
  ...
  int v17_r9 = atomic_load_explicit(&vars[3+v14_r8], memory_order_acquire);
