...
lbl_LC00:;
  ...
  int v14 = (v4_r4 == 2);
  atomic_store_explicit(&atom_1_r4_2, v14, memory_order_release);
  int v15 = (v7_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(&atom_1_r4_2, memory_order_acquire);
