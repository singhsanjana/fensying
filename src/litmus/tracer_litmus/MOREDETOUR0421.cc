// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0421.litmus
...
lbl_LC00:;
  ...
  int v14 = (v4_r5 == 3);
  atomic_store_explicit(&atom_1_r5_3, v14, memory_order_release);
  int v15 = (v7_r6 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(&atom_1_r5_3, memory_order_acquire);
