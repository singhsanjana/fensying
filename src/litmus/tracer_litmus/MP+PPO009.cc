// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO009.litmus
...
label_2:;
  ...
  int v17 = (v12_r12 == 0);
  atomic_store_explicit(&atom_1_r12_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(&atom_1_r12_0, memory_order_acquire);
