// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/hh4.litmus
...
label_2:;
  ...
  int v11 = (v2_r2 == 2);
  atomic_store_explicit(&atom_1_r2_2, v11, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v4 = atomic_load_explicit(&atom_1_r2_2, memory_order_acquire);
