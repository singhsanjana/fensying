...
label_2:;
  ...
  int v12_r8 = atomic_load_explicit(&vars[2+v9_r7], memory_order_acquire);
  int v13_cmpeq = (v12_r8 == v12_r8);
  if (v13_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v15_r10 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(&atom_1_r10_0, memory_order_acquire);
