// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0213.litmus
...
lbl_LC00:;
  ...
  int v13_r7 = atomic_load_explicit(&vars[2], memory_order_acquire);
  int v14_r8 = v13_r7 ^ v13_r7;
  int v15_r8 = v14_r8 + 1;
  atomic_store_explicit(&vars[3], v15_r8, memory_order_release);
