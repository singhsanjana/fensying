...
label_2:;
  ...
  int v16_r12 = atomic_load_explicit(&vars[0+v13_r11], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_release);
  int v24 = (v16_r12 == 0);
  atomic_store_explicit(&atom_1_r12_0, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(&atom_1_r12_0, memory_order_acquire);
