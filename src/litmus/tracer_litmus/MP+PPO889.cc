...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v6_r8], 1, memory_order_release);
  int v8_r11 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v10_r12 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v20, memory_order_release);
  int v21 = (v10_r12 == 1);
  atomic_store_explicit(&atom_1_r12_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(&atom_1_r12_1, memory_order_acquire);
