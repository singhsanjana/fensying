// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO379.litmus
...
lbl_LC01:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v11_r11 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v18, memory_order_release);
  int v19 = (v11_r11 == 0);
  atomic_store_explicit(&atom_1_r11_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(&vars[3], memory_order_acquire);
  int v13 = (v12 == 2);
