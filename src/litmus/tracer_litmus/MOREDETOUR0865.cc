...
label_4:;
  ...
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v10_r4 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v26 = (v10_r4 == 4);
  atomic_store_explicit(&atom_3_r4_4, v26, memory_order_release);
  int v27 = (v8_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(&atom_3_r4_4, memory_order_acquire);
