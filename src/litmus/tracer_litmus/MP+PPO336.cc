// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO336.litmus
...
label_2:;
  ...
  int v8_r6 = v7_r6 + 1;
  atomic_store_explicit(&vars[2], v8_r6, memory_order_release);
...
lbl_LC00:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v13_r9 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
