...
label_2:;
  ...
  int v9_r9 = atomic_load_explicit(&vars[0+v6_r8], memory_order_acquire);
  int v15 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v15, memory_order_release);
  int v16 = (v5_r7 == 2);
  atomic_store_explicit(&atom_1_r7_2, v16, memory_order_release);
  int v17 = (v9_r9 == 0);
  atomic_store_explicit(&atom_1_r9_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(&atom_1_r9_0, memory_order_acquire);
