// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+PPO054.litmus
...
label_2:;
  ...
  int v18_r12 = atomic_load_explicit(&vars[4+v15_r11], memory_order_acquire);
  int v19_r14 = v18_r12 ^ v18_r12;
  atomic_store_explicit(&vars[0+v19_r14], 1, memory_order_release);
  int v24 = (v2_r1 == 1);
