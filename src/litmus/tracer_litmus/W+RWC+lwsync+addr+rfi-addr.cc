// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/W+RWC+lwsync+addr+rfi-addr.litmus
...
label_3:;
  ...
  int v23 = (v12_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v23, memory_order_release);
