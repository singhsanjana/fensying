// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0248.litmus
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(&atom_1_r5_3, memory_order_acquire);
