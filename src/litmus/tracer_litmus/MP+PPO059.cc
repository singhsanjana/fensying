// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO059.litmus
...
lbl_LC00:;
  ...
  int v9_r7 = v8_r7 + 1;
  atomic_store_explicit(&vars[3], v9_r7, memory_order_release);
  int v11_r9 = atomic_load_explicit(&vars[3], memory_order_acquire);
  int v12_r10 = v11_r9 ^ v11_r9;
  int v15_r11 = atomic_load_explicit(&vars[0+v12_r10], memory_order_acquire);
  int v19 = (v2_r1 == 1);
