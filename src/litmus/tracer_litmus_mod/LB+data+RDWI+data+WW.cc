...
label_2:;
  ...
  int v10_r5 = v9_r5 + 1;
  atomic_store_explicit(__LINE__, &vars[2], v10_r5, memory_order_release);
  atomic_store_explicit(__LINE__, &vars[0], 1, memory_order_release);
  int v20 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v20, memory_order_release);
  int v21 = (v8_r4 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r4_2, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r4_2, memory_order_acquire);
