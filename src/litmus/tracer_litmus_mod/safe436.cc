...
label_1:;
  ...
  atomic_store_explicit(__LINE__, &vars[0+v3_r3], 2, memory_order_release);
  int v23 = (v2_r1 == 1);
...
label_3:;
  ...
  atomic_fetch_add_explicit(__LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v9_r3 = atomic_load_explicit(__LINE__, &vars[1], memory_order_acquire);
  int v26 = (v9_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r3_1, v26, memory_order_release);
