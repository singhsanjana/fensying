...
label_1:;
  ...
  atomic_store_explicit(__LINE__, &vars[2+v3_r7], 1, memory_order_release);
  int v12 = (v2_r6 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r6_2, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = (v6 == 2);
  int v8 = atomic_load_explicit(__LINE__, &atom_0_r6_2, memory_order_acquire);
