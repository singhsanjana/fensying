...
label_2:;
  ...
  int v23 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r3_2, v23, memory_order_release);
  int v24 = (v6_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r5_0, v24, memory_order_release);
...
label_3:;
  ...
  int v25 = (v8_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r3_1, v25, memory_order_release);
  int v26 = (v12_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r5_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r5_0, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, &atom_2_r3_1, memory_order_acquire);
  int v18 = atomic_load_explicit(__LINE__, &atom_2_r5_0, memory_order_acquire);
