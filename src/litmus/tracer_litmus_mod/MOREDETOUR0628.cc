...
label_1:;
  ...
  int v20 = (v2_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_0_r4_4, v20, memory_order_release);
...
label_2:;
  ...
  int v21 = (v7_r4 == 3);
  atomic_store_explicit(__LINE__, &atom_1_r4_3, v21, memory_order_release);
  int v22 = (v5_r1 == 1);
...
label_4:;
  ...
  int v23 = (v9_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_3_r3_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_3_r3_0, memory_order_acquire);
