...
label_3:;
  ...
  int v21 = (v6_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r3_0, v21, memory_order_release);
...
label_5:;
  ...
  int v22 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_4_r3_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v10 = (v9 == 2);
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_4_r3_0, memory_order_acquire);
