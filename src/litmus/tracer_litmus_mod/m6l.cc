...
label_3:;
  ...
  int v13 = (v4_r2 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r2_1, v13, memory_order_release);
  int v14 = (v6_r1 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r1_0, v14, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__LINE__, &atom_2_r2_1, memory_order_acquire);
