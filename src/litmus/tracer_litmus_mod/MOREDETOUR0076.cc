...
label_3:;
  ...
  int v24 = (v7_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_2_r1_3, v24, memory_order_release);
  int v25 = (v11_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r4_0, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_2_r1_3, memory_order_acquire);
