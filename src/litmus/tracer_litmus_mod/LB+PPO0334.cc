// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0334.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[4], v15_r10, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v17 = (v16 == 2);
