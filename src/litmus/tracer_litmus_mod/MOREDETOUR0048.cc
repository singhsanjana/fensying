...
label_2:;
  ...
  int v23 = (v6_r4 == 3);
  atomic_store_explicit(__LINE__, &atom_1_r4_3, v23, memory_order_release);
  int v24 = (v4_r1 == 1);
...
label_4:;
  ...
  int v26 = (v12_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_3_r4_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_0_r4_4, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, &atom_1_r4_3, memory_order_acquire);
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_3_r4_0, memory_order_acquire);
