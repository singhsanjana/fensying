// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0948.litmus
...
label_2:;
  ...
  int v6_r6 = atomic_load_explicit(__LINE__, &vars[0+v3_r5], memory_order_acquire);
  ...
  int v19 = (v8_r8 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r8_1, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_1_r8_1, memory_order_acquire);
