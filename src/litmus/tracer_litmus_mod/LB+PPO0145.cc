// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0145.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[5], v20_r12, memory_order_release);
