...
label_1:;
  ...
  int v27 = (v2_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r1_3, v27, memory_order_release);
...
label_2:;
  ...
  int v12_r6 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  ...
  int v30 = (v12_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r6_1, v30, memory_order_release);
...
label_4:;
  ...
  int v31 = (v14_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r1_1, v31, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_0_r1_3, memory_order_acquire);
