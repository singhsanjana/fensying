...
label_3:;
  ...
  int v27 = (v8_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r3_2, v27, memory_order_release);
...
label_4:;
  ...
  int v28 = (v12_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_3_r4_4, v28, memory_order_release);
  int v29 = (v10_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_3_r4_4, memory_order_acquire);
