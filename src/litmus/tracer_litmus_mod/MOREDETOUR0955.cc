...
label_4:;
  ...
  int v21 = (v8_r4 == 3);
  atomic_store_explicit(__LINE__, &atom_3_r4_3, v21, memory_order_release);
  int v22 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_3_r4_3, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, &atom_3_r1_1, memory_order_acquire);
