...
label_2:;
  ...
  int v20 = (v4_r5 == 5);
  atomic_store_explicit(__LINE__, &atom_1_r5_5, v20, memory_order_release);
...
label_3:;
  ...
  int v21 = (v8_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_2_r4_4, v21, memory_order_release);
  int v22 = (v6_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v11 = (v10 == 2);
  int v12 = atomic_load_explicit(__LINE__, &atom_1_r5_5, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, &atom_2_r4_4, memory_order_acquire);
