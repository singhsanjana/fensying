...
label_2:;
  ...
  int v9_r8 = atomic_load_explicit(__LINE__, &vars[2], memory_order_acquire);
  ...
  int v21 = (v13_r11 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r11_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_1_r11_1, memory_order_acquire);
