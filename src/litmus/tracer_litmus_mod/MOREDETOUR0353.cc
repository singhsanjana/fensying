...
label_1:;
  ...
  int v22 = (v2_r3 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r3_3, v22, memory_order_release);
...
label_4:;
  ...
  int v24 = (v11_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r5_2, v24, memory_order_release);
  int v25 = (v7_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_3_r1_3, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_3_r1_3, memory_order_acquire);
