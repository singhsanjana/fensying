...
label_1:;
  ...
  int v22 = (v2_r4 == 5);
  atomic_store_explicit(__LINE__, &atom_0_r4_5, v22, memory_order_release);
...
label_2:;
  ...
  int v23 = (v6_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_1_r4_4, v23, memory_order_release);
  int v24 = (v4_r1 == 2);
...
label_4:;
  ...
  int v25 = (v12_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r5_2, v25, memory_order_release);
  int v26 = (v8_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_0_r4_5, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, &atom_1_r4_4, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r1_2, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, &atom_3_r5_2, memory_order_acquire);
