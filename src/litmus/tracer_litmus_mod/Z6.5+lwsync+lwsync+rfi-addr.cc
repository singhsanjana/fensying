...
label_3:;
  ...
  int v16 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r3_2, v16, memory_order_release);
  int v17 = (v6_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r5_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__LINE__, &atom_2_r3_2, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, &atom_2_r5_0, memory_order_acquire);
