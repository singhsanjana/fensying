// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1230.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[0+v5_r7], 1, memory_order_release);
  int v15 = (v2_r3 == 0);
