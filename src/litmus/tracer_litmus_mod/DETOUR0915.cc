...
label_1:;
  ...
  int v12 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r5_2, v12, memory_order_release);
...
label_2:;
  ...
  int v13 = (v4_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_1_r4_4, v13, memory_order_release);
  int v14 = (v6_r5 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__LINE__, &atom_1_r4_4, memory_order_acquire);
