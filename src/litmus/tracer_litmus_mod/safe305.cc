...
label_1:;
  ...
  int v26 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r1_2, v26, memory_order_release);
  int v27 = (v6_r4 == 0);
...
label_3:;
  ...
  int v29 = (v12_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r4_0, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__LINE__, &atom_2_r1_2, memory_order_acquire);
  int v20 = atomic_load_explicit(__LINE__, &atom_2_r4_0, memory_order_acquire);
