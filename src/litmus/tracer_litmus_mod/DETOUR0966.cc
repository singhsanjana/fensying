// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0966.litmus
...
label_1:;
  ...
  int v17 = (v4_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r6_1, v17, memory_order_release);
