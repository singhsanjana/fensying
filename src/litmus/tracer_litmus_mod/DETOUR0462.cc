...
label_1:;
  ...
  int v14 = (v2_r3 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r3_3, v14, memory_order_release);
...
label_3:;
  ...
  int v15 = (v8_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r5_2, v15, memory_order_release);
  int v16 = (v4_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r1_2, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, &atom_0_r3_3, memory_order_acquire);
  int v10 = atomic_load_explicit(__LINE__, &atom_2_r5_2, memory_order_acquire);
