...
label_3:;
  ...
  int v4_r6 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v16 = (v2_r5 == 55);
  atomic_store_explicit(__LINE__, &atom_2_r5_55, v16, memory_order_release);
  int v17 = (v4_r6 == 66);
  atomic_store_explicit(__LINE__, &atom_2_r6_66, v17, memory_order_release);
...
label_4:;
  ...
  int v18 = (v6_r5 == 66);
  atomic_store_explicit(__LINE__, &atom_3_r5_66, v18, memory_order_release);
  int v19 = (v8_r6 == 55);
  atomic_store_explicit(__LINE__, &atom_3_r6_55, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, &atom_2_r5_55, memory_order_acquire);
  int v10 = atomic_load_explicit(__LINE__, &atom_2_r6_66, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, &atom_3_r5_66, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, &atom_3_r6_55, memory_order_acquire);
