...
label_1:;
  ...
  int v21 = (v2_r3 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r3_3, v21, memory_order_release);
...
label_4:;
  ...
  int v23 = (v10_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r5_2, v23, memory_order_release);
  int v24 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, &atom_0_r3_3, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v13 = (v12 == 5);
  int v14 = atomic_load_explicit(__LINE__, &atom_2_r1_3, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, &atom_3_r5_2, memory_order_acquire);
