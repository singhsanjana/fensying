...
label_2:;
  ...
  int v25 = (v6_r4 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r4_1, v25, memory_order_release);
...
label_4:;
  ...
  int v27 = (v10_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r3_1, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_3_r3_1, memory_order_acquire);
