// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0304.litmus
...
label_3:;
  ...
  int v19 = (v6_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_2_r1_3, v19, memory_order_release);
