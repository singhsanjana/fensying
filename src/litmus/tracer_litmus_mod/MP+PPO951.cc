...
lbl_LC01:;
  ...
  int v8_r9 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v10_r10 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v20, memory_order_release);
  int v21 = (v10_r10 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r10_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r10_1, memory_order_acquire);
