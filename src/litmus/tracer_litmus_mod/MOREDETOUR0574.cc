// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0574.litmus
...
label_2:;
  ...
  int v17 = (v4_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r5_0, v17, memory_order_release);
...
label_3:;
  ...
  int v18 = (v8_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_2_r4_4, v18, memory_order_release);
  int v19 = (v6_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r1_2, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, &atom_2_r4_4, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, &atom_2_r1_2, memory_order_acquire);
