...
lbl_LC00:;
  int v5_r4 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v12 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r3_2, v12, memory_order_release);
  int v13 = (v5_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r4_0, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, &atom_1_r4_0, memory_order_acquire);
  int v10_conj = v8 & v9;
