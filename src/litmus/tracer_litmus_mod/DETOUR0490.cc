...
label_1:;
  ...
  int v14 = (v2_r5 == 4);
  atomic_store_explicit(__LINE__, &atom_0_r5_4, v14, memory_order_release);
...
label_2:;
  ...
  int v15 = (v8_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r5_2, v15, memory_order_release);
  int v16 = (v4_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, &atom_0_r5_4, memory_order_acquire);
