...
label_2:;
  ...
  int v9_r9 = atomic_load_explicit(__LINE__, &vars[3+v6_r8], memory_order_acquire);
  int v10_r11 = v9_r9 ^ v9_r9;
  atomic_store_explicit(__LINE__, &vars[0+v10_r11], 1, memory_order_release);
  int v12_r14 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v12_r14 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r14_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_1_r14_1, memory_order_acquire);
