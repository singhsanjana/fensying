// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO205.litmus
...
label_2:;
  ...
  int v10_r9 = atomic_load_explicit(__LINE__, &vars[2], memory_order_acquire);
  int v11_r10 = v10_r9 ^ v10_r9;
  int v14_r11 = atomic_load_explicit(__LINE__, &vars[0+v11_r10], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v21, memory_order_release);
  int v22 = (v14_r11 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r11_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_1_r11_0, memory_order_acquire);
