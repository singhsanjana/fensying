// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0538.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[3+v11_r6], 1, memory_order_release);
  int v13_r9 = atomic_load_explicit(__LINE__, &vars[3], memory_order_acquire);
  int v14_r10 = v13_r9 ^ v13_r9;
  int v17_r11 = atomic_load_explicit(__LINE__, &vars[4+v14_r10], memory_order_acquire);
  int v19_r13 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
