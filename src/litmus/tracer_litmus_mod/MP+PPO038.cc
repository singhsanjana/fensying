...
label_2:;
  ...
  int v20_r14 = atomic_load_explicit(__LINE__, &vars[0+v17_r13], memory_order_acquire);
  int v24 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v24, memory_order_release);
  int v25 = (v20_r14 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r14_0, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v22 = atomic_load_explicit(__LINE__, &atom_1_r14_0, memory_order_acquire);
