...
def model_checking_output(filename, traces_batch_size, total_iter, cds_y_flag, cds_total_time, tool_total_time):
	cds = translate_cds(filename, traces_batch_size, total_iter, cds_y_flag, cds_total_time, tool_total_time)								# translates CDS Checker output & returns a structure containing the traces
