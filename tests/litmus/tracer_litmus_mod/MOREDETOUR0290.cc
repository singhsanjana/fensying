...
label_1:;
  ...
  int v24 = (v2_r5 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_5, v24, memory_order_release);
...
label_3:;
  ...
  int v27 = (v14_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_2, v27, memory_order_release);
  int v28 = (v10_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_5, memory_order_acquire);
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r5_2, memory_order_acquire);
