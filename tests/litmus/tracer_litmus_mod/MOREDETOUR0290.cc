...
label_1:;
  ...
  int v4_r6 = v3_r6 + 1;
  atomic_store_explicit(__LINE__, &vars[1], v4_r6, memory_order_release);
  int v24 = (v2_r5 == 5);
  atomic_store_explicit(__LINE__, &atom_0_r5_5, v24, memory_order_release);
...
label_2:;
  ...
  int v25 = (v8_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_1_r4_4, v25, memory_order_release);
  int v26 = (v6_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r1_2, v26, memory_order_release);
...
label_3:;
  ...
  int v27 = (v14_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r5_2, v27, memory_order_release);
  int v28 = (v10_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_0_r5_5, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r4_4, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, &atom_1_r1_2, memory_order_acquire);
  int v18 = atomic_load_explicit(__LINE__, &atom_2_r5_2, memory_order_acquire);
