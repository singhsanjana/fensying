...
label_2:;
  ...
  int v18 = (v2_r2 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r2_1, v18, memory_order_release);
...
label_3:;
  ...
  int v19 = (v5_r2 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r2_2, v19, memory_order_release);
  int v20 = (v9_r1 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r2_2, memory_order_acquire);
