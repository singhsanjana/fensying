// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe389.litmus
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_1, memory_order_acquire);
