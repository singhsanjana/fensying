// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe390.litmus
...
label_2:;
  ...
  int v7_r3 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v21 = (v5_r1 == 1);
