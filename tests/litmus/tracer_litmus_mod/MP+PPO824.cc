// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO824.litmus
...
lbl_LC00:;
  ...
  int v15_r11 = atomic_load_explicit(__LINE__, &vars[0+v12_r10], memory_order_acquire);
  int v17_r13 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
