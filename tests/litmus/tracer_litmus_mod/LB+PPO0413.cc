// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0413.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[4], v18_r10, memory_order_release);
  int v20_r12 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
