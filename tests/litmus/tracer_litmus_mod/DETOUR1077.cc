...
label_1:;
  ...
  int v15 = (v2_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_2, v15, memory_order_release);
  int v16 = (v4_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_3, v16, memory_order_release);
...
label_4:;
  ...
  int v17 = (v6_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r3_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_3, memory_order_acquire);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r3_0, memory_order_acquire);
