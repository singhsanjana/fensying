// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0926.litmus
...
label_2:;
  ...
  int v18 = (v7_r7 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_2, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_2, memory_order_acquire);
