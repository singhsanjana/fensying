// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO156.litmus
...
label_2:;
  ...
  int v11_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v12_r12 = v11_r11 ^ v11_r11;
  int v15_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v12_r12], memory_order_acquire);
  int v22 = (v2_r1 == 1);
