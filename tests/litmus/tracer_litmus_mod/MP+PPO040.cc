// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO040.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[4], v11_r10, memory_order_release);
