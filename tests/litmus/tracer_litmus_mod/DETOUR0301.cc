...
label_1:;
  ...
  int v15 = (v2_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_3, v15, memory_order_release);
...
label_2:;
  ...
  int v17 = (v9_r7 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_2, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_3, memory_order_acquire);
