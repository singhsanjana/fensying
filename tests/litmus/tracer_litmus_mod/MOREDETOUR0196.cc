// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0196.litmus
...
lbl_LC00:;
  ...
  int v13_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v10_r5], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_0, memory_order_acquire);
