// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0521.litmus
...
label_2:;
  ...
  int v15 = (v4_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_3, v15, memory_order_release);
  int v16 = (v8_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_0, v16, memory_order_release);
