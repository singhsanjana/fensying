...
label_3:;
  ...
  int v14 = (v5_r2 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r2_1, v14, memory_order_release);
  int v15 = (v7_r3 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r2_1, memory_order_acquire);
