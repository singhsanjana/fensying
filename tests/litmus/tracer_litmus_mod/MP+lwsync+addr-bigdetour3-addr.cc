...
void t3(void *arg){
label_4:;
  int v14_r1 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v15_r3 = v14_r1 ^ v14_r1;
  int v16_r2 = v15_r3 + 1;
  atomic_store_explicit(__LINE__, &vars[3], v16_r2, memory_order_release);
  int v30 = (v14_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__LINE__, &atom_1_r6_1, memory_order_acquire);
  int v21 = atomic_load_explicit(__LINE__, &atom_3_r1_1, memory_order_acquire);
