...
label_3:;
  ...
  int v18 = (v4_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_4, v18, memory_order_release);
  int v19 = (v8_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r1_4, memory_order_acquire);
