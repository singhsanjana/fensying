// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0831.litmus
...
label_2:;
  ...
  int v15 = (v4_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_4, v15, memory_order_release);
  int v16 = (v8_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_4, memory_order_acquire);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_0, memory_order_acquire);
