// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO889.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v6_r8], 1, memory_order_release);
  int v8_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v10_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
