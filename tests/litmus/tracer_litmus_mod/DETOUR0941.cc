// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0941.litmus
...
label_2:;
  ...
  int v12 = (v4_r7 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_2, v12, memory_order_release);
