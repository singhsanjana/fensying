// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO477.litmus
...
lbl_LC01:;
  ...
  int v17 = (v12_r8 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_0, v17, memory_order_release);
