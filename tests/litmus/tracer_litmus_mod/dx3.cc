// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/dx3.litmus
...
label_1:;
  ...
  int v11 = (v2_r2 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r2_2, v11, memory_order_release);
