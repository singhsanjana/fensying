// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO895.litmus
...
label_2:;
  ...
  int v17 = (v9_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_1, v17, memory_order_release);
