// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/W+RW+RW+RR+WR+WR+lwsync+sync+lwsync+sync+sync.litmus
...
label_4:;
  ...
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v8_r3 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v26 = (v6_r1 == 1);
