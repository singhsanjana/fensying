...
label_4:;
  ...
  int v7_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  ...
  int v22 = (v11_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r7_0, v22, memory_order_release);
