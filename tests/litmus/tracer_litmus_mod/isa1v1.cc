// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/isa1v1.litmus
...
label_3:;
  ...
  int v8_r2 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v5_r3], memory_order_acquire);
  int v15 = (v4_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_2, v15, memory_order_release);
  int v16 = (v8_r2 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r2_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r2_0, memory_order_acquire);
