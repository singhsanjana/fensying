// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO278.litmus
...
label_2:;
  ...
  int v11_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[3+v8_r9], memory_order_acquire);
