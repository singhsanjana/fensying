...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3], v2_r1, memory_order_release);

}

void t2(void *arg){
label_3:;
  int v4_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
...
lbl_L2:;
  ...
  int v15 = (v4_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r6_1, v15, memory_order_release);
  int v16 = (v7_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r6_1, memory_order_acquire);
