// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/R0113.litmus
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v10 = (v9 == 2);
