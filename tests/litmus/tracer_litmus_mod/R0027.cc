// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/R0027.litmus
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 2);
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_1, memory_order_acquire);
  int v10_conj = v8 & v9;
