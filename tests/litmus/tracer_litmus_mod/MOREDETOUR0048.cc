...
label_1:;
  ...
  int v22 = (v2_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_4, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_4, memory_order_acquire);
