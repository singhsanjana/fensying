// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO244.litmus
...
label_2:;
  ...
  int v13_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v10_r11], memory_order_acquire);
  int v14_cmpeq = (v13_r12 == v13_r12);
  if (v14_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v16_r14 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v23, memory_order_release);
  int v24 = (v16_r14 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r14_0, v24, memory_order_release);
