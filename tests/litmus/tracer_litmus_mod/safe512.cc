// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe512.litmus
...
label_1:;
  ...
  int v28 = (v2_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_2, v28, memory_order_release);
...
label_2:;
  ...
  int v29 = (v4_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v29, memory_order_release);
  int v30 = (v8_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_1, v30, memory_order_release);
...
label_3:;
  ...
  int v31 = (v10_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_2, v31, memory_order_release);
  int v32 = (v12_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_0, v32, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = (v15 == 2);
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_1, memory_order_acquire);
  int v20 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r1_2, memory_order_acquire);
  int v21 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
