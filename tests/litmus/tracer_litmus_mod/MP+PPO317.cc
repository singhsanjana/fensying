// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO317.litmus
...
label_2:;
  ...
  int v12_r9 = v11_r9 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[4], v12_r9, memory_order_release);
  int v14_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v15_cmpeq = (v14_r11 == v14_r11);
  if (v15_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v17_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r12_0, memory_order_acquire);
