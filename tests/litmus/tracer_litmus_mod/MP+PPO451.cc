// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO451.litmus
...
lbl_LC00:;
  ...
  int v23 = (v15_r10 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r10_0, memory_order_acquire);
