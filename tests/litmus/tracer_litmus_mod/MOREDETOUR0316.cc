...
label_2:;
  ...
  int v17 = (v2_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_3, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 5);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r1_3, memory_order_acquire);
