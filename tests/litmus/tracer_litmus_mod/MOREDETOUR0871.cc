...
label_1:;
  ...
  int v20 = (v2_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_2, v20, memory_order_release);
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v5_r5], 1, memory_order_release);
  int v21 = (v4_r4 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_5, v21, memory_order_release);
...
label_3:;
  ...
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v9_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v22 = (v9_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_4, v22, memory_order_release);
  int v23 = (v7_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_2, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = (v11 == 2);
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_5, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_4, memory_order_acquire);
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r1_2, memory_order_acquire);
