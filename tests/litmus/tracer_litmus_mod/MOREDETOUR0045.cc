// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0045.litmus
...
label_1:;
  ...
  int v22 = (v2_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_4, v22, memory_order_release);
...
label_2:;
  ...
  int v23 = (v6_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_3, v23, memory_order_release);
  int v24 = (v4_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_4, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_3, memory_order_acquire);
