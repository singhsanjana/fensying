// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WRW+2W+lwsync+rfi-data.litmus
...
label_3:;
  ...
  int v17 = (v4_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_2, v17, memory_order_release);
