...
label_4:;
  ...
  int v20 = (v6_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r3_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r3_1, memory_order_acquire);
