// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO880.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v6_r7], 1, memory_order_release);
  ...
  int v18 = (v10_r11 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r11_1, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r11_1, memory_order_acquire);
