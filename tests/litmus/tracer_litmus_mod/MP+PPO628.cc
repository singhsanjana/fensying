// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO628.litmus
...
label_2:;
  ...
  int v10_r8 = v9_r8 + 1;
  atomic_store_explicit(__LINE__, &vars[0], v10_r8, memory_order_release);
  ...
  int v23 = (v12_r10 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r10_1, v23, memory_order_release);
