...
label_2:;
  ...
  int v18 = (v2_r6 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_4, v18, memory_order_release);
...
label_3:;
  ...
  int v19 = (v6_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v19, memory_order_release);
  int v20 = (v4_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 5);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_4, memory_order_acquire);
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
