// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0585.litmus
...
label_2:;
  ...
  int v13 = (v4_r5 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_3, v13, memory_order_release);
  int v14 = (v6_r6 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_3, memory_order_acquire);
