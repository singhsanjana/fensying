// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0618.litmus
...
lbl_LC00:;
  ...
  int v12 = (v2_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_2, v12, memory_order_release);
  int v13 = (v5_r6 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v7 = (v6 == 2);
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
