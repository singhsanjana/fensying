...
label_2:;
  ...
  int v18 = (v7_r8 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_2, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r8_2, memory_order_acquire);
