...
label_4:;
  ...
  int v23 = (v6_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_4, v23, memory_order_release);
  int v24 = (v10_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_4, memory_order_acquire);
