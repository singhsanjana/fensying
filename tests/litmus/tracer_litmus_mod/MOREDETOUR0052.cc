...
label_1:;
  ...
  int v21 = (v2_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_2, v21, memory_order_release);
...
label_3:;
  ...
  int v23 = (v6_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_4, v23, memory_order_release);
  int v24 = (v10_r4 == 0);
