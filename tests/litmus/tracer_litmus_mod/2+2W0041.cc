// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/2+2W0041.litmus
...
label_2:;
  ...
  int v4_r5 = v3_r5 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[3], v4_r5, memory_order_release);
