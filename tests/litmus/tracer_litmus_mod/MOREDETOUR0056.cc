// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0056.litmus
...
label_1:;
  ...
  int v6_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[2+v3_r5], memory_order_acquire);
  atomic_store_explicit(__FILE__, __LINE__, &vars[2], 2, memory_order_release);
  int v21 = (v6_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r6_0, memory_order_acquire);
