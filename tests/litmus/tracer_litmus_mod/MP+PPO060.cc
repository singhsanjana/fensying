// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO060.litmus
...
label_2:;
  ...
  int v8_r6 = v7_r6 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[2], v8_r6, memory_order_release);
