...
label_1:;
  ...
  int v21 = (v12_r2 == 0);
  atomic_store_explicit(__LINE__, &atom_0_r2_0, v21, memory_order_release);
  int v22 = (v6_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_0_r3_0, v22, memory_order_release);
  int v23 = (v8_r4 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r4_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_0_r4_1, memory_order_acquire);
