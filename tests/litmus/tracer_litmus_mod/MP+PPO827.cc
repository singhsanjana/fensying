// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO827.litmus
...
lbl_LC01:;
  ...
  int v12_r10 = atomic_load_explicit(__LINE__, &vars[0+v9_r9], memory_order_acquire);
