// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0426.litmus
...
label_1:;
  ...
  int v16 = (v2_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_4, v16, memory_order_release);
