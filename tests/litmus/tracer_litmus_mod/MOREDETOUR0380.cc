// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0380.litmus
...
lbl_LC00:;
  ...
  int v22 = (v4_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_4, v22, memory_order_release);
  int v23 = (v7_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_0, v23, memory_order_release);
...
label_3:;
  ...
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v11_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v24 = (v11_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v24, memory_order_release);
  int v25 = (v9_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r3_0, memory_order_acquire);
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_4, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_0, memory_order_acquire);
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
