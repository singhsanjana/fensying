// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0021.litmus
...
label_1:;
  ...
  int v18 = (v6_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_0, v18, memory_order_release);
