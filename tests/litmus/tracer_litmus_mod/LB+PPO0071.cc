// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0071.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[4+v15_r10], 1, memory_order_release);
