// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0289.litmus
...
label_1:;
  ...
  int v11 = (v2_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_3, v11, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_3, memory_order_acquire);
