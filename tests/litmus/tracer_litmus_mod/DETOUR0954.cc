// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0954.litmus
...
label_2:;
  ...
  int v14 = (v2_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_0, v14, memory_order_release);
  int v15 = (v4_r7 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_1, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 2);
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_1, memory_order_acquire);
  int v11_conj = v9 & v10;
