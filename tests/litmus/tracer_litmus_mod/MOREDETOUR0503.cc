// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0503.litmus
...
label_2:;
  ...
  int v23 = (v8_r7 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_3, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_3, memory_order_acquire);
