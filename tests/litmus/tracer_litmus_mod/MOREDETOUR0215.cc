...
label_1:;
  ...
  int v22 = (v2_r1 == 4);
  atomic_store_explicit(__LINE__, &atom_0_r1_4, v22, memory_order_release);
...
label_2:;
  ...
  int v24 = (v9_r6 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r6_2, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_1_r6_2, memory_order_acquire);
