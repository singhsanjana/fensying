// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0215.litmus
...
label_2:;
  ...
  int v24 = (v9_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_2, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_2, memory_order_acquire);
