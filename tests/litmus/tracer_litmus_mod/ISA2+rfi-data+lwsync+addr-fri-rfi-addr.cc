...
label_3:;
  ...
  int v12_r4 = atomic_load_explicit(__LINE__, &vars[3+v9_r3], memory_order_acquire);
  atomic_store_explicit(__LINE__, &vars[3], 1, memory_order_release);
  int v14_r7 = atomic_load_explicit(__LINE__, &vars[3], memory_order_acquire);
  int v15_r8 = v14_r7 ^ v14_r7;
  int v18_r9 = atomic_load_explicit(__LINE__, &vars[0+v15_r8], memory_order_acquire);
  int v32 = (v8_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r1_1, v32, memory_order_release);
  int v33 = (v12_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r4_0, v33, memory_order_release);
  int v34 = (v14_r7 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r7_1, v34, memory_order_release);
  int v35 = (v18_r9 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r9_0, v35, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(__LINE__, &atom_2_r1_1, memory_order_acquire);
  int v22 = atomic_load_explicit(__LINE__, &atom_2_r4_0, memory_order_acquire);
  int v23 = atomic_load_explicit(__LINE__, &atom_2_r7_1, memory_order_acquire);
  int v24 = atomic_load_explicit(__LINE__, &atom_2_r9_0, memory_order_acquire);
