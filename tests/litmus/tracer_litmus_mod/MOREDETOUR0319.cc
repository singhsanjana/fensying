// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0319.litmus
...
label_1:;
  ...
  int v22 = (v2_r5 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_5, v22, memory_order_release);
...
label_3:;
  ...
  int v25 = (v12_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_2, v25, memory_order_release);
  int v26 = (v8_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_5, memory_order_acquire);
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r5_2, memory_order_acquire);
