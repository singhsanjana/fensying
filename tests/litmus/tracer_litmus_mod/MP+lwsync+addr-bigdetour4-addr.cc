...
label_2:;
  ...
  int v25 = (v12_r9 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r9_0, v25, memory_order_release);
  int v26 = (v6_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r9_0, memory_order_acquire);
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_0, memory_order_acquire);
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_1, memory_order_acquire);
