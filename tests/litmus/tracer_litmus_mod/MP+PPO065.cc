...
lbl_LC01:;
  ...
  int v12_r11 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v13_r12 = v12_r11 ^ v12_r11;
  int v16_r13 = atomic_load_explicit(__LINE__, &vars[0+v13_r12], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v20, memory_order_release);
  int v21 = (v16_r13 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r13_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_1_r13_0, memory_order_acquire);
