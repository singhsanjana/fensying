...
label_1:;
  ...
  int v26 = (v2_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_3, v26, memory_order_release);
...
lbl_LC00:;
  ...
  int v29 = (v11_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_1, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_3, memory_order_acquire);
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_1, memory_order_acquire);
