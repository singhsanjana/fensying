// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/isa1v9.litmus
...
label_3:;
  ...
  int v8_r2 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v5_r9], memory_order_acquire);
  int v15 = (v4_r1 == 2);
