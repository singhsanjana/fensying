...
label_1:;
  ...
  int v23 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r3_2, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(__LINE__, &atom_0_r3_2, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, &atom_1_r3_2, memory_order_acquire);
