...
label_3:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v11_r3], 1, memory_order_release);
  int v25 = (v10_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r3_2, memory_order_acquire);
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
