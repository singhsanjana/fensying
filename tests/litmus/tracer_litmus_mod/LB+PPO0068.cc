// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0068.litmus
...
lbl_LC00:;
  ...
  int v13_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v14_r9 = v13_r8 ^ v13_r8;
  int v17_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v14_r9], memory_order_acquire);
  int v18_r12 = v17_r10 ^ v17_r10;
  atomic_store_explicit(__FILE__, __LINE__, &vars[5+v18_r12], 1, memory_order_release);
