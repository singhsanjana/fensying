...
void t3(void *arg){
label_4:;
  int v2_r1 = atomic_load_explicit(__LINE__, &vars[3], memory_order_acquire);
  int v3_r3 = v2_r1 ^ v2_r1;
  int v6_r4 = atomic_load_explicit(__LINE__, &vars[4+v3_r3], memory_order_acquire);
  atomic_store_explicit(__LINE__, &vars[0], 1, memory_order_release);
  int v8_r8 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r1_1, v21, memory_order_release);
  int v22 = (v8_r8 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r8_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_3_r8_1, memory_order_acquire);
