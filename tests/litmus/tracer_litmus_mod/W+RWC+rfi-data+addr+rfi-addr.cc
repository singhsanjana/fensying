...
label_3:;
  ...
  int v29 = (v12_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r3_1, v29, memory_order_release);
  int v30 = (v16_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r5_0, v30, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__LINE__, &atom_2_r3_1, memory_order_acquire);
