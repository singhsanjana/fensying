...
label_3:;
  ...
  int v30 = (v16_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_0, v30, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_1, memory_order_acquire);
