// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/3.SB+eieio+lwsync+lwsync.litmus
...
label_3:;
  ...
  int v14 = (v6_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_0, v14, memory_order_release);
