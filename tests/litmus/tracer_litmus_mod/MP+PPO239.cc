// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO239.litmus
...
lbl_LC01:;
  ...
  int v12_r10 = atomic_load_explicit(__LINE__, &vars[4+v9_r9], memory_order_acquire);
...
lbl_LC02:;
  ...
  int v20 = (v15_r12 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r12_0, v20, memory_order_release);
