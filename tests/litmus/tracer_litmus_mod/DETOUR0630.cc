// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0630.litmus
...
label_2:;
  ...
  int v16 = (v4_r5 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r5_1, v16, memory_order_release);
  int v17 = (v6_r6 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v9 = (v8 == 3);
  int v10 = atomic_load_explicit(__LINE__, &atom_1_r5_1, memory_order_acquire);
