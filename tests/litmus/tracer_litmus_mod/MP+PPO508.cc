// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO508.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v10_r11], 1, memory_order_release);
  int v12_r14 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v12_r14 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r14_1, v23, memory_order_release);
