// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/podrwposwr020.litmus
...
label_4:;
  ...
  int v25 = (v8_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r5_1, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r5_1, memory_order_acquire);
