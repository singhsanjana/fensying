...
label_2:;
  ...
  int v16_r15 = atomic_load_explicit(__LINE__, &vars[0+v13_r14], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v20, memory_order_release);
  int v21 = (v16_r15 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r15_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_1_r15_0, memory_order_acquire);
