// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO832.litmus
...
label_2:;
  ...
  int v9_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v10_r11 = v9_r10 ^ v9_r10;
  int v13_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v10_r11], memory_order_acquire);
  int v15_r14 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
