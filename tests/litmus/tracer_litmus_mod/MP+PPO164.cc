...
label_2:;
  ...
  int v20_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v17_r12], memory_order_acquire);
  int v24 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v22 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r13_0, memory_order_acquire);
