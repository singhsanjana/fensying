...
label_1:;
  ...
  int v16 = (v2_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_3, v16, memory_order_release);
...
label_3:;
  ...
  int v17 = (v10_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_2, v17, memory_order_release);
  int v18 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r5_2, memory_order_acquire);
