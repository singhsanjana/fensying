// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO013.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[4+v11_r9], 1, memory_order_release);
  int v13_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v14_r13 = v13_r12 ^ v13_r12;
  int v17_r14 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v14_r13], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v21, memory_order_release);
  int v22 = (v17_r14 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r14_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r14_0, memory_order_acquire);
