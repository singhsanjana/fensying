// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0013.litmus
...
label_2:;
  ...
  int v18_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v15_r9], memory_order_acquire);
