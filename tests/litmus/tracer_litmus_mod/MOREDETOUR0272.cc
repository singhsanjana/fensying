...
label_1:;
  ...
  int v25 = (v2_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_4, v25, memory_order_release);
...
label_3:;
  ...
  int v28 = (v10_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_2, v28, memory_order_release);
