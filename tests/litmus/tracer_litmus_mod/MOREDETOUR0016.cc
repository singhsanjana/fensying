...
label_1:;
  ...
  int v4_r6 = v3_r6 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[1], v4_r6, memory_order_release);
  int v24 = (v2_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_4, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_4, memory_order_acquire);
