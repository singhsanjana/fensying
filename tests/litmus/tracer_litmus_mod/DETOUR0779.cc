// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0779.litmus
...
label_2:;
  ...
  int v13 = (v5_r7 == 3);
  atomic_store_explicit(__LINE__, &atom_1_r7_3, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, &atom_1_r7_3, memory_order_acquire);
  int v10_conj = v8 & v9;
