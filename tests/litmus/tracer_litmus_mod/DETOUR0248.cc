...
label_2:;
  ...
  int v23 = (v10_r5 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_3, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_3, memory_order_acquire);
