// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WW+RW+RR+WW+WR+WR+lwsync+sync+lwsync+sync+sync+sync.litmus
...
void t4(void *arg){
label_5:;
  atomic_store_explicit(__LINE__, &vars[4], 2, memory_order_release);
  atomic_fetch_add_explicit(__LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v8_r3 = atomic_load_explicit(__LINE__, &vars[5], memory_order_acquire);
  int v26 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_4_r3_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v12 = (v11 == 2);
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_4_r3_0, memory_order_acquire);
