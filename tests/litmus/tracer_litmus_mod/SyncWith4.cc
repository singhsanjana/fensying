...
lbl_L0:;
  ...
  int v7_r4 = atomic_load_explicit(__LINE__, &vars[1], memory_order_acquire);
  int v26 = (v5_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r1_1, v26, memory_order_release);
  int v27 = (v7_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_0_r4_0, v27, memory_order_release);
  int v28 = (v2_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r6_1, v28, memory_order_release);
...
void t2(void *arg){
label_3:;
  int v9_r6 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
...
lbl_L2:;
  ...
  int v14_r4 = atomic_load_explicit(__LINE__, &vars[5], memory_order_acquire);
  int v29 = (v12_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r1_1, v29, memory_order_release);
  int v30 = (v14_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r4_0, v30, memory_order_release);
  int v31 = (v9_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r6_1, v31, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_0_r6_1, memory_order_acquire);
  ...
  int v20 = atomic_load_explicit(__LINE__, &atom_2_r6_1, memory_order_acquire);
