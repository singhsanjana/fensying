// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO588.litmus
...
label_2:;
  ...
  int v8_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v9_r7 = v8_r6 ^ v8_r6;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v9_r7], 1, memory_order_release);
  int v11_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v21, memory_order_release);
  int v22 = (v11_r10 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r10_1, memory_order_acquire);
