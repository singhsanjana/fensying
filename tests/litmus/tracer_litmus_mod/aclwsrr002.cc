...
label_1:;
  ...
  int v30 = (v8_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_0_r5_0, v30, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_0_r3_1, memory_order_acquire);
  int v19 = atomic_load_explicit(__LINE__, &atom_0_r5_0, memory_order_acquire);
