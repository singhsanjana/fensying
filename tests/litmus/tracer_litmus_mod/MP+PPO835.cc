// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO835.litmus
...
label_2:;
  ...
  int v14_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v11_r10], memory_order_acquire);
  int v16_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v23, memory_order_release);
  int v24 = (v16_r13 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r13_0, v24, memory_order_release);
