...
label_2:;
  ...
  int v10 = (v2_r6 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_3, v10, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 4);
  int v7 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_3, memory_order_acquire);
  int v8_conj = v6 & v7;
