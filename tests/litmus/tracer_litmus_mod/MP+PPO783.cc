// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO783.litmus
...
label_2:;
  ...
  int v9_r9 = atomic_load_explicit(__LINE__, &vars[0+v6_r8], memory_order_acquire);
