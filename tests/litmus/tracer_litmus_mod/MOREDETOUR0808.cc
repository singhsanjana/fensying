...
label_2:;
  ...
  int v21 = (v5_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_2, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_2, memory_order_acquire);
