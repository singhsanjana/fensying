// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0130.litmus
...
label_2:;
  ...
  int v10_r6 = v9_r6 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v10_r6, memory_order_release);
  int v25 = (v6_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v25, memory_order_release);
  int v26 = (v8_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_4, v26, memory_order_release);

}

void t2(void *arg){
label_3:;
  int v12_r1 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  atomic_store_explicit(__FILE__, __LINE__, &vars[1], 2, memory_order_release);
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v14_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v27 = (v14_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v27, memory_order_release);
  int v28 = (v12_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_4, memory_order_acquire);
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
