...
label_2:;
  ...
  int v10_r6 = v9_r6 + 1;
  atomic_store_explicit(__LINE__, &vars[0], v10_r6, memory_order_release);
  int v25 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v25, memory_order_release);
  int v26 = (v8_r5 == 4);
  atomic_store_explicit(__LINE__, &atom_1_r5_4, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_1_r5_4, memory_order_acquire);
