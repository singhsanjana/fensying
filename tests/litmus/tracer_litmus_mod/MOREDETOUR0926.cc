...
label_4:;
  ...
  int v22 = (v8_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r3_2, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = (v10 == 3);
  int v12 = atomic_load_explicit(__LINE__, &atom_1_r3_3, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, &atom_1_r4_0, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, &atom_3_r3_2, memory_order_acquire);
