// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/PPOAA.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[2+v3_r11], 1, memory_order_release);
