...
label_4:;
  ...
  int v10_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v11_r6 = v10_r5 ^ v10_r5;
  int v14_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v11_r6], memory_order_acquire);
  int v24 = (v8_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_1, v24, memory_order_release);
  int v25 = (v14_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r7_0, v25, memory_order_release);
