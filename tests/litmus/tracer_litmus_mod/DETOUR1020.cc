// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1020.litmus
...
lbl_LC00:;
  ...
  int v16 = (v2_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r3_1, v16, memory_order_release);
  int v17 = (v4_r4 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r4_2, v17, memory_order_release);
...
label_3:;
  ...
  int v18 = (v7_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r3_0, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = (v8 == 2);
  int v10 = atomic_load_explicit(__LINE__, &atom_0_r3_1, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, &atom_0_r4_2, memory_order_acquire);
