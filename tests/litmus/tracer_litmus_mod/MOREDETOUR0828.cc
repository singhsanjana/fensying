// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0828.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v7_r6], 1, memory_order_release);
...
label_3:;
  ...
  int v21 = (v11_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v21, memory_order_release);
  int v22 = (v9_r1 == 1);
