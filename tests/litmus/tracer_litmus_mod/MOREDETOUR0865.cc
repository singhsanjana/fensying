// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0865.litmus
...
label_3:;
  ...
  int v25 = (v6_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_2, v25, memory_order_release);
...
label_4:;
  ...
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v10_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v26 = (v10_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_4, v26, memory_order_release);
  int v27 = (v8_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_2, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_2, memory_order_acquire);
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_4, memory_order_acquire);
