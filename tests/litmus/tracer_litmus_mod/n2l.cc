// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/n2l.litmus
...
label_1:;
  ...
  int v18 = (v4_r2 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r2_0, v18, memory_order_release);
...
label_2:;
  ...
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v8_r2 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v17 = (v6_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v17, memory_order_release);
  int v19 = (v8_r2 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r2_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r2_0, memory_order_acquire);
