// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0800.litmus
...
label_2:;
  ...
  int v19 = (v8_r7 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_3, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_3, memory_order_acquire);
