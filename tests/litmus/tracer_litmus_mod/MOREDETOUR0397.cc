// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0397.litmus
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__LINE__, &atom_1_r3_0, memory_order_acquire);
