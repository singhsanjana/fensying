// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0204.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[4], v20_r11, memory_order_release);
