// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO521.litmus
...
label_2:;
  ...
  int v16 = (v8_r10 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_1, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r10_1, memory_order_acquire);
