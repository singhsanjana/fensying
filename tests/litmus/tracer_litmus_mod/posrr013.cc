...
label_4:;
  ...
  int v25 = (v8_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r3_1, v25, memory_order_release);
  int v26 = (v12_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_3_r5_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_3_r3_1, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, &atom_3_r5_0, memory_order_acquire);
