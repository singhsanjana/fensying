// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0256.litmus
...
label_2:;
  ...
  int v8_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
