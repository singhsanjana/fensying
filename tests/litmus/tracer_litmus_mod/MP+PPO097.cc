...
label_2:;
  ...
  int v7_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v8_r10 = v7_r9 ^ v7_r9;
  int v11_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v8_r10], memory_order_acquire);
  int v21 = (v2_r1 == 1);
