// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1037.litmus
...
label_3:;
  ...
  int v16 = (v8_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_0, v16, memory_order_release);
