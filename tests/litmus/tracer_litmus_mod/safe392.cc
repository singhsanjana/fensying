// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe392.litmus
...
label_1:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v3_r3], 2, memory_order_release);
  int v20 = (v2_r1 == 1);
...
label_2:;
  ...
  int v7_r3 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v21 = (v5_r1 == 2);
...
label_3:;
  ...
  int v23 = (v9_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_0, v23, memory_order_release);
