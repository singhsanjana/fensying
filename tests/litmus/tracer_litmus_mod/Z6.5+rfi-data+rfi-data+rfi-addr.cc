...
label_1:;
  ...
  int v28 = (v2_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_1, v28, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = (v15 == 2);
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v18 = (v17 == 2);
  ...
  int v21 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_2, memory_order_acquire);
