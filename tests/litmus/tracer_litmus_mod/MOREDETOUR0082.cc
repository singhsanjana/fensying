// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0082.litmus
...
label_1:;
  ...
  int v4_r5 = v3_r5 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[2], v4_r5, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r1_3, memory_order_acquire);
