...
label_4:;
  ...
  int v25 = (v8_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_3, v25, memory_order_release);
  int v26 = (v12_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_3, memory_order_acquire);
