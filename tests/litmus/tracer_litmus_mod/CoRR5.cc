...
label_1:;
  ...
  int v36 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r1_2, v36, memory_order_release);
  int v37 = (v4_r2 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r2_2, v37, memory_order_release);
  int v40 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r1_1, v40, memory_order_release);
  int v41 = (v4_r2 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r2_1, v41, memory_order_release);
...
label_2:;
  ...
  int v38 = (v6_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r1_2, v38, memory_order_release);
  int v39 = (v8_r2 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r2_2, v39, memory_order_release);
  int v42 = (v8_r2 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r2_1, v42, memory_order_release);
  int v43 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v43, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, &atom_0_r2_2, memory_order_acquire);
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_1_r1_2, memory_order_acquire);
  int v19 = atomic_load_explicit(__LINE__, &atom_1_r2_2, memory_order_acquire);
  int v20_conj = v18 & v19;
  int v21_conj = v17 & v20_conj;
  int v22 = atomic_load_explicit(__LINE__, &atom_0_r2_1, memory_order_acquire);
  int v23 = atomic_load_explicit(__LINE__, &atom_1_r1_2, memory_order_acquire);
  int v24 = atomic_load_explicit(__LINE__, &atom_1_r2_2, memory_order_acquire);
  int v25 = atomic_load_explicit(__LINE__, &atom_1_r2_1, memory_order_acquire);
  int v26_disj = v24 | v25;
  int v27_conj = v23 & v26_disj;
  int v28 = atomic_load_explicit(__LINE__, &atom_1_r1_1, memory_order_acquire);
  int v29 = atomic_load_explicit(__LINE__, &atom_1_r2_1, memory_order_acquire);
