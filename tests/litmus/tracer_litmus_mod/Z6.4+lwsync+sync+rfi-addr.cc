...
label_3:;
  ...
  int v18 = (v4_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_1, v18, memory_order_release);
  int v19 = (v8_r5 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_1, memory_order_acquire);
