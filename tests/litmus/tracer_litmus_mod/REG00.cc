// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/REG00.litmus
...
label_4:;
  ...
  int v20 = (v9_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r3_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r3_0, memory_order_acquire);
