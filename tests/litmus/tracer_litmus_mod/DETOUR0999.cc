...
label_1:;
  ...
  int v18 = (v4_r4 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_2, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_2, memory_order_acquire);
