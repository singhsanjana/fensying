// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0062.litmus
...
label_1:;
  ...
  int v6_r7 = v5_r7 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[2], v6_r7, memory_order_release);
  int v20 = (v2_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_0, v20, memory_order_release);
  int v21 = (v4_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_1, v21, memory_order_release);
