// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WRR+2W+addr+rfi-data.litmus
...
label_3:;
  ...
  int v21 = (v8_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_1, v21, memory_order_release);
