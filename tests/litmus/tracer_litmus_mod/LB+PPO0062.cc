// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0062.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v11_r6], 1, memory_order_release);
  int v13_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v14_r10 = v13_r9 ^ v13_r9;
  int v17_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v14_r10], memory_order_acquire);
  int v18_r13 = v17_r11 ^ v17_r11;
  atomic_store_explicit(__FILE__, __LINE__, &vars[5+v18_r13], 1, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_1, memory_order_acquire);
