// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP0023.litmus
...
label_1:;
  ...
  int v6_r7 = v5_r7 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[3], v6_r7, memory_order_release);
