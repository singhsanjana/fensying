...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v5_r6], 1, memory_order_release);
  int v21 = (v4_r5 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_5, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = (v11 == 2);
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_5, memory_order_acquire);
