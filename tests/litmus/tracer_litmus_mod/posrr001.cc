...
label_3:;
  ...
  int v12_r7 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v23 = (v4_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r1_1, v23, memory_order_release);
  int v24 = (v6_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r3_1, v24, memory_order_release);
  int v25 = (v10_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r5_0, v25, memory_order_release);
  int v26 = (v12_r7 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r7_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_2_r5_0, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, &atom_2_r7_0, memory_order_acquire);
