// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe302.litmus
...
label_4:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v9_r3], 1, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = (v10 == 2);
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
