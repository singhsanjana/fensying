// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0421.litmus
...
lbl_LC00:;
  ...
  int v15_r9 = v14_r9 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[4], v15_r9, memory_order_release);
  int v17_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
