...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v11_r8], 1, memory_order_release);
  ...
  int v23 = (v15_r12 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r12_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r12_1, memory_order_acquire);
