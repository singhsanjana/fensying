// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO897.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[0+v11_r8], 1, memory_order_release);
  int v13_r11 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v15_r12 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v15_r12 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r12_1, v23, memory_order_release);
