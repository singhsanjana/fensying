// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0605.litmus
...
label_2:;
  ...
  int v15 = (v7_r8 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_2, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 3);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r8_2, memory_order_acquire);
