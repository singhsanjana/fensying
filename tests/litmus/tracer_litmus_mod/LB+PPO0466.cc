// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0466.litmus
...
lbl_LC00:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v10_r6], 1, memory_order_release);
