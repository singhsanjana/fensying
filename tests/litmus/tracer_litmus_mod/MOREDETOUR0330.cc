// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0330.litmus
...
label_1:;
  ...
  int v20 = (v6_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r6_0, memory_order_acquire);
