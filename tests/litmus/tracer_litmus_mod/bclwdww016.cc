...
label_4:;
  ...
  int v22 = (v8_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_1, memory_order_acquire);
