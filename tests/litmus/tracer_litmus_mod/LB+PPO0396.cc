...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v10_r8], 1, memory_order_release);
  int v12_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
