...
label_1:;
  ...
  int v27 = (v2_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_4, v27, memory_order_release);
...
label_4:;
  ...
  int v31 = (v14_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_2, v31, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_4, memory_order_acquire);
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_2, memory_order_acquire);
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v20 = (v19 == 4);
  int v21 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_2, memory_order_acquire);
