...
lbl_LC00:;
  ...
  int v11_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v8_r7], memory_order_acquire);
  int v19 = (v2_r1 == 1);
  ...
  int v22 = (v11_r8 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_0, v22, memory_order_release);
