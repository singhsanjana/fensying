// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO710.litmus
...
lbl_LC01:;
  ...
  int v11_r12 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v18, memory_order_release);
  int v19 = (v11_r12 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r12_1, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r12_1, memory_order_acquire);
