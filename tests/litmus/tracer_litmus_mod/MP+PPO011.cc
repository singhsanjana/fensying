// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO011.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v8_r8], 1, memory_order_release);
  int v10_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v11_r12 = v10_r11 ^ v10_r11;
  int v14_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v11_r12], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v18, memory_order_release);
  int v19 = (v14_r13 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r13_0, v19, memory_order_release);
