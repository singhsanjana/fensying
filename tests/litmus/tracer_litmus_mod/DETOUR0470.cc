// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0470.litmus
...
label_3:;
  ...
  int v14 = (v4_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_3, v14, memory_order_release);
