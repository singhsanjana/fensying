...
label_2:;
  ...
  int v19 = (v8_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_1, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_1, memory_order_acquire);
