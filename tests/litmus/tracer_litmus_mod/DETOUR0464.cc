...
label_1:;
  ...
  int v13 = (v2_r6 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r6_2, v13, memory_order_release);
...
label_2:;
  ...
  int v14 = (v4_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_1_r1_3, v14, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(__LINE__, &atom_0_r6_2, memory_order_acquire);
