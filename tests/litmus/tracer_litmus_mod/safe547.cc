...
label_1:;
  ...
  int v26 = (v6_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_1, v26, memory_order_release);
...
label_2:;
  ...
  int v27 = (v8_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_2, v27, memory_order_release);
