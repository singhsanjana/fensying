// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/podww001.litmus
...
int user_main(int argc, char **argv){
  ...
  int v1 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v2 = (v1 == 2);
