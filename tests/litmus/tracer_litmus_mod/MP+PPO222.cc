// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO222.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[2+v5_r5], 1, memory_order_release);
