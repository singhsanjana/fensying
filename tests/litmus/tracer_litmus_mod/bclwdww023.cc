// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/bclwdww023.litmus
...
label_4:;
  ...
  int v24 = (v10_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r3_1, v24, memory_order_release);
