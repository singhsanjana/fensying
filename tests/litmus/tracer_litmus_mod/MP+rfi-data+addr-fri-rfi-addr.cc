...
label_1:;
  ...
  int v26 = (v2_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r3_1, v26, memory_order_release);
...
label_2:;
  ...
  int v28 = (v10_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r4_0, v28, memory_order_release);
  int v29 = (v12_r7 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r7_1, v29, memory_order_release);
  int v30 = (v16_r9 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r9_0, v30, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__LINE__, &atom_1_r4_0, memory_order_acquire);
  int v20 = atomic_load_explicit(__LINE__, &atom_1_r7_1, memory_order_acquire);
  int v21 = atomic_load_explicit(__LINE__, &atom_1_r9_0, memory_order_acquire);
