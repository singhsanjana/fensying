...
label_1:;
  ...
  int v29 = (v6_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_1, v29, memory_order_release);
...
label_2:;
  ...
  int v30 = (v8_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_2, v30, memory_order_release);
