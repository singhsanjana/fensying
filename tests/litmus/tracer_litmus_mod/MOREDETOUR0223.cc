// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0223.litmus
...
lbl_LC00:;
  int v13_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
