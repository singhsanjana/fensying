// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO618.litmus
...
lbl_LC00:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v10_r10, memory_order_release);
