// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0318.litmus
...
label_2:;
  ...
  int v22 = (v4_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_2, v22, memory_order_release);
...
label_3:;
  ...
  int v23 = (v10_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_2, v23, memory_order_release);
  int v24 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_4, memory_order_acquire);
