...
label_2:;
  ...
  int v27 = (v6_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r4_0, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_1_r4_0, memory_order_acquire);
  int v19 = atomic_load_explicit(__LINE__, &atom_3_r1_2, memory_order_acquire);
  int v20 = atomic_load_explicit(__LINE__, &atom_3_r4_0, memory_order_acquire);
