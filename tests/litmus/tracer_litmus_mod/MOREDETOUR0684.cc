...
label_3:;
  ...
  int v20 = (v6_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_4, v20, memory_order_release);
  int v21 = (v4_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_4, memory_order_acquire);
