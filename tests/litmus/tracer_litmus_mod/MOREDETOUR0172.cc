...
label_4:;
  ...
  int v29 = (v12_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_3, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = (v17 == 5);
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_3, memory_order_acquire);
