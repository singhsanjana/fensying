// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe546.litmus
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_0, memory_order_acquire);
