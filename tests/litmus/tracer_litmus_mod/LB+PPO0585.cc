// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0585.litmus
...
label_2:;
  ...
  int v14_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
