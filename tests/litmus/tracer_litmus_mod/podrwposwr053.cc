...
label_4:;
  ...
  int v4_r5 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v5_r6 = v4_r5 ^ v4_r5;
  int v8_r7 = atomic_load_explicit(__LINE__, &vars[0+v5_r6], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r1_1, v18, memory_order_release);
  int v19 = (v8_r7 == 0);
  atomic_store_explicit(__LINE__, &atom_3_r7_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_3_r7_0, memory_order_acquire);
