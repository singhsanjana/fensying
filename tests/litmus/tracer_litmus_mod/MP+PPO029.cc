...
lbl_LC00:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v8_r7], 1, memory_order_release);
  int v10_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v11_r11 = v10_r10 ^ v10_r10;
  int v14_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v11_r11], memory_order_acquire);
  int v18 = (v2_r1 == 1);
