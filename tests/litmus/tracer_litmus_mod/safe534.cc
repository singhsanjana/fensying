// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe534.litmus
...
label_1:;
  ...
  int v29 = (v6_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_0, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_0, memory_order_acquire);
