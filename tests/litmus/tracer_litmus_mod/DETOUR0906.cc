// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0906.litmus
...
label_2:;
  ...
  int v11 = (v2_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_2, v11, memory_order_release);
  int v12 = (v4_r7 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 2);
  int v7 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_2, memory_order_acquire);
