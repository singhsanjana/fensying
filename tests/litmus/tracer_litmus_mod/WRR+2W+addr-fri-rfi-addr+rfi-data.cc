...
label_2:;
  ...
  int v29 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r1_2, v29, memory_order_release);
  int v30 = (v6_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r4_0, v30, memory_order_release);
  int v31 = (v8_r7 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r7_1, v31, memory_order_release);
  int v32 = (v12_r9 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r9_0, v32, memory_order_release);
...
label_3:;
  ...
  int v14_r3 = atomic_load_explicit(__LINE__, &vars[2], memory_order_acquire);
  int v15_r4 = v14_r3 ^ v14_r3;
  int v16_r4 = v15_r4 + 1;
  atomic_store_explicit(__LINE__, &vars[0], v16_r4, memory_order_release);
  int v33 = (v14_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r3_1, v33, memory_order_release);
