...
label_1:;
  ...
  int v19 = (v6_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_0, v19, memory_order_release);
...
label_3:;
  ...
  int v21 = (v10_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_0, v21, memory_order_release);
