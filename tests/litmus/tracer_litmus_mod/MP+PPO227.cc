// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO227.litmus
...
label_2:;
  ...
  int v16_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v13_r10], memory_order_acquire);
  int v17_cmpeq = (v16_r11 == v16_r11);
  if (v17_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v19_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
