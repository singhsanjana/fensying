...
label_2:;
  ...
  int v12_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[2+v9_r5], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_2, memory_order_acquire);
