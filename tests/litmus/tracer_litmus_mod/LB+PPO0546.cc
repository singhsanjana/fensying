// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0546.litmus
...
label_2:;
  ...
  int v13_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[3+v10_r8], memory_order_acquire);
  int v15_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
