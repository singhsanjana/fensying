// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0027.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[2+v9_r4], 1, memory_order_release);
