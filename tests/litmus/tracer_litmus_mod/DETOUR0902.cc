// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0902.litmus
...
label_2:;
  ...
  int v12 = (v4_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_0, v12, memory_order_release);
