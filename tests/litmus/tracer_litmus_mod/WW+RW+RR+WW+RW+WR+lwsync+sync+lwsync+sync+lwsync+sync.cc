// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WW+RW+RR+WW+RW+WR+lwsync+sync+lwsync+sync+lwsync+sync.litmus
...
label_3:;
  ...
  int v25 = (v6_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_0, v25, memory_order_release);
