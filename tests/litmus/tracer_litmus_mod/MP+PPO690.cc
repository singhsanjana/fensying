...
lbl_LC01:;
  ...
  int v24 = (v16_r14 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r14_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r14_1, memory_order_acquire);
