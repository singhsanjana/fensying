// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/podrwposwr047.litmus
...
label_3:;
  ...
  int v4_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  ...
  int v16 = (v8_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r7_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r7_0, memory_order_acquire);
