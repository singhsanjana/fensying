// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO810.litmus
...
label_2:;
  ...
  int v11_r10 = atomic_load_explicit(__LINE__, &vars[0+v8_r9], memory_order_acquire);
