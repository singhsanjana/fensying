// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/W+RW+RW+RR+WW+WR+lwsync+sync+lwsync+sync+sync.litmus
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v12 = (v11 == 2);
