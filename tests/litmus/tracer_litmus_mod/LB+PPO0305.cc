...
label_2:;
  ...
  int v16_r8 = atomic_load_explicit(__LINE__, &vars[3+v13_r7], memory_order_acquire);
  int v17_r10 = v16_r8 ^ v16_r8;
  atomic_store_explicit(__LINE__, &vars[4+v17_r10], 1, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v19 = (v18 == 2);
