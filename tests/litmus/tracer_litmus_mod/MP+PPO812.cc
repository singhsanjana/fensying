// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO812.litmus
...
label_2:;
  ...
  int v15_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v12_r11], memory_order_acquire);
  int v17_r14 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
