...
label_3:;
  ...
  int v10_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[1+v7_r3], memory_order_acquire);
  int v26 = (v6_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_1, v26, memory_order_release);
  int v27 = (v10_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_1, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_1, memory_order_acquire);
