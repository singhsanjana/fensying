// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0397.litmus
...
label_1:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[1+v5_r6], 1, memory_order_release);
  int v19 = (v2_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_3, v19, memory_order_release);
  int v20 = (v4_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_4, v20, memory_order_release);
