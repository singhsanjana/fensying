// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO016.litmus
...
lbl_LC00:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[4+v10_r9], 1, memory_order_release);
  int v12_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v13_r13 = v12_r12 ^ v12_r12;
  int v16_r14 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v13_r13], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v20, memory_order_release);
  int v21 = (v16_r14 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r14_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r14_0, memory_order_acquire);
