...
label_3:;
  ...
  int v16 = (v6_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_4, v16, memory_order_release);
  int v17 = (v4_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_4, memory_order_acquire);
