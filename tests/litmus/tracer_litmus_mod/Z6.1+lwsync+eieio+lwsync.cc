// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/Z6.1+lwsync+eieio+lwsync.litmus
...
label_3:;
  ...
  int v10 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r1_1, v10, memory_order_release);
