// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO287.litmus
...
lbl_LC00:;
  ...
  int v21 = (v16_r13 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r13_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r13_0, memory_order_acquire);
