// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO804.litmus
...
label_2:;
  ...
  int v9_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v6_r7], memory_order_acquire);
  ...
  int v16 = (v11_r10 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r10_0, memory_order_acquire);
