// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0302.litmus
...
label_2:;
  ...
  int v18 = (v10_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_2, v18, memory_order_release);
