...
label_2:;
  ...
  int v27 = (v8_r7 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_1, v27, memory_order_release);
...
label_3:;
  ...
  int v28 = (v12_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v28, memory_order_release);
  int v29 = (v10_r1 == 1);
