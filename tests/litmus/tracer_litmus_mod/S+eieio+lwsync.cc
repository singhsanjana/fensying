// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+eieio+lwsync.litmus
...
label_2:;
  ...
  int v7 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v7, memory_order_release);
