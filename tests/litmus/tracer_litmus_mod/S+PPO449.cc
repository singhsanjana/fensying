// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+PPO449.litmus
...
label_2:;
  ...
  int v9_r10 = v8_r10 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v9_r10, memory_order_release);
  int v20 = (v2_r1 == 1);
