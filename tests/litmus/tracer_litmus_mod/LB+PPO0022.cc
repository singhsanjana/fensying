...
lbl_LC01:;
  ...
  int v12_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v13_r9 = v12_r8 ^ v12_r8;
  int v16_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v13_r9], memory_order_acquire);
