// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0061.litmus
...
label_1:;
  ...
  int v17 = (v2_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_0, v17, memory_order_release);
...
label_3:;
  ...
  int v18 = (v4_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_2, v18, memory_order_release);
  int v19 = (v8_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_0, memory_order_acquire);
