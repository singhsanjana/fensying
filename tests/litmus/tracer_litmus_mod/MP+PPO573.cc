...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v15_r11], 1, memory_order_release);
  ...
  int v25 = (v17_r14 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r14_1, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r14_1, memory_order_acquire);
