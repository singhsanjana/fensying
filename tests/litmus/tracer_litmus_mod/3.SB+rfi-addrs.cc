...
label_1:;
  ...
  int v31 = (v6_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_0_r5_0, v31, memory_order_release);
...
label_2:;
  ...
  int v32 = (v8_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r3_1, v32, memory_order_release);
  int v33 = (v12_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r5_0, v33, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__LINE__, &atom_0_r5_0, memory_order_acquire);
  int v21 = atomic_load_explicit(__LINE__, &atom_1_r3_1, memory_order_acquire);
  int v22 = atomic_load_explicit(__LINE__, &atom_1_r5_0, memory_order_acquire);
