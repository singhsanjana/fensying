...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v5_r4], 1, memory_order_release);
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], 3, memory_order_release);
  int v21 = (v4_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_3, v21, memory_order_release);
...
label_4:;
  ...
  int v22 = (v9_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_3, v22, memory_order_release);
  int v23 = (v7_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_3, memory_order_acquire);
