...
label_2:;
  ...
  int v8_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v5_r5], memory_order_acquire);
  int v23 = (v4_r4 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_5, v23, memory_order_release);
  int v24 = (v8_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_0, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_0, memory_order_acquire);
