...
label_2:;
  ...
  int v23 = (v4_r4 == 5);
  atomic_store_explicit(__LINE__, &atom_1_r4_5, v23, memory_order_release);
  int v24 = (v8_r6 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r6_0, v24, memory_order_release);
...
label_3:;
  ...
  int v25 = (v12_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_2_r4_4, v25, memory_order_release);
  int v26 = (v10_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_1_r4_5, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r6_0, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, &atom_2_r4_4, memory_order_acquire);
