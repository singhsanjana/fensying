...
lbl_LC00:;
  ...
  int v17 = (v12_r11 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r11_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r11_0, memory_order_acquire);
