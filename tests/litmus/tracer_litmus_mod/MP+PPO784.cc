// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO784.litmus
...
label_2:;
  ...
  int v23 = (v12_r11 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r11_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r11_1, memory_order_acquire);
