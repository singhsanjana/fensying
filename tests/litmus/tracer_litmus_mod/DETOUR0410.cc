...
label_1:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[1+v5_r5], 1, memory_order_release);
  int v19 = (v2_r3 == 3);
...
label_4:;
  ...
  int v21 = (v11_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r5_2, v21, memory_order_release);
  int v22 = (v7_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r5_2, memory_order_acquire);
