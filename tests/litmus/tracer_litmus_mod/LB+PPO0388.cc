// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0388.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[4+v14_r10], 1, memory_order_release);
  int v16_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
