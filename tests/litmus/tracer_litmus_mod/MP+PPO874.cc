// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO874.litmus
...
label_2:;
  ...
  int v12_r13 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v14_r14 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v21, memory_order_release);
  int v22 = (v14_r14 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r14_1, v22, memory_order_release);
