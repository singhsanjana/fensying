// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0216.litmus
...
label_1:;
  ...
  int v23 = (v2_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_4, v23, memory_order_release);
...
label_2:;
  ...
  int v10_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  ...
  int v25 = (v10_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_2, v25, memory_order_release);
...
void t3(void *arg){
label_4:;
  int v12_r1 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_4, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
