// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/non-treelike-coherence.litmus
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_2, memory_order_acquire);
