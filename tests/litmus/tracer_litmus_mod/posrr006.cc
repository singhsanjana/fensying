...
label_4:;
  ...
  int v12_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v24 = (v6_r1 == 1);
  ...
  int v26 = (v12_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r6_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r6_0, memory_order_acquire);
