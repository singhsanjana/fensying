...
label_2:;
  ...
  int v12 = (v4_r6 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_3, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = (v6 == 4);
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_3, memory_order_acquire);
  int v9_conj = v7 & v8;
