// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO680.litmus
...
label_2:;
  ...
  int v10_r7 = v9_r7 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v10_r7, memory_order_release);
  int v12_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v12_r9 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r9_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r9_1, memory_order_acquire);
