// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/IRWIW+addrs.litmus
...
label_4:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v6_r3], 1, memory_order_release);
  int v17 = (v5_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_2, v17, memory_order_release);
