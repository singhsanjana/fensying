...
label_3:;
  ...
  int v23 = (v8_r4 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r4_1, v23, memory_order_release);
...
label_4:;
  ...
  int v24 = (v10_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_3_r3_0, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_2_r4_1, memory_order_acquire);
