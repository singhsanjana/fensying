...
label_2:;
  ...
  int v22 = (v6_r6 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_3, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_3, memory_order_acquire);
