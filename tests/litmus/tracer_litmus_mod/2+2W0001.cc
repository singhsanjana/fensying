// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/2+2W0001.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v7_r8], 1, memory_order_release);
