...
label_1:;
  ...
  int v21 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r5_2, v21, memory_order_release);
...
lbl_LC00:;
  int v7_r5 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v22 = (v4_r4 == 5);
  atomic_store_explicit(__LINE__, &atom_1_r4_5, v22, memory_order_release);
  int v23 = (v7_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r5_0, v23, memory_order_release);
...
label_3:;
  ...
  int v24 = (v11_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_2_r4_4, v24, memory_order_release);
  int v25 = (v9_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, &atom_0_r5_2, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, &atom_1_r4_5, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, &atom_1_r5_0, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, &atom_2_r4_4, memory_order_acquire);
