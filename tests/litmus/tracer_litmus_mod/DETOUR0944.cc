// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0944.litmus
...
label_2:;
  ...
  int v15 = (v4_r7 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_3, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_3, memory_order_acquire);
  int v11_conj = v9 & v10;
