...
label_1:;
  ...
  int v15 = (v2_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_1, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_1, memory_order_acquire);
