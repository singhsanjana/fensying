...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v11_r5], 1, memory_order_release);
  int v20 = (v6_r1 == 1);
  ...
  int v22 = (v10_r4 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_2, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_2, memory_order_acquire);
