// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO022.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v9_r8], 1, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r13_0, memory_order_acquire);
