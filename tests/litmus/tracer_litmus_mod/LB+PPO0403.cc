...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v15_r8], 1, memory_order_release);
  int v17_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
