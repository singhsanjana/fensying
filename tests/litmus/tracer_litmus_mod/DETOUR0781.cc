...
lbl_LC00:;
  ...
  int v13 = (v5_r6 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_3, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_3, memory_order_acquire);
  int v10_conj = v8 & v9;
