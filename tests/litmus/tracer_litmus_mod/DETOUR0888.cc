...
label_2:;
  ...
  int v7 = (v2_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_0, v7, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v4 = (v3 == 2);
  int v5 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_0, memory_order_acquire);
  int v6_conj = v4 & v5;
