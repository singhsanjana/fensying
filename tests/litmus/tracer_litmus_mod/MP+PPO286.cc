// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO286.litmus
...
lbl_LC00:;
  ...
  int v20 = (v15_r14 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r14_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r14_0, memory_order_acquire);
