...
label_1:;
  ...
  int v24 = (v4_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r6_1, v24, memory_order_release);
...
label_2:;
  ...
  int v25 = (v8_r4 == 3);
  atomic_store_explicit(__LINE__, &atom_1_r4_3, v25, memory_order_release);
  int v26 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_0_r6_1, memory_order_acquire);
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_2_r3_0, memory_order_acquire);
