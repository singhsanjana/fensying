...
label_2:;
  ...
  int v8_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v30 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v30, memory_order_release);
  int v31 = (v8_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_1, v31, memory_order_release);
...
label_4:;
  ...
  int v32 = (v10_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_1, v32, memory_order_release);
  int v33 = (v16_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r8_1, v33, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v22 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r8_1, memory_order_acquire);
  int v23 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_1, memory_order_acquire);
  int v24 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r8_1, memory_order_acquire);
