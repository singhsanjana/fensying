// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO951.litmus
...
lbl_LC01:;
  ...
  int v21 = (v10_r10 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r10_1, memory_order_acquire);
