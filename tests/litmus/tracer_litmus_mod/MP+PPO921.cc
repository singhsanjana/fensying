// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO921.litmus
...
lbl_LC00:;
  ...
  int v7_r7 = v6_r7 + 1;
  atomic_store_explicit(__LINE__, &vars[0], v7_r7, memory_order_release);
  int v9_r9 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
