// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+PPO233.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[0+v17_r12], 1, memory_order_release);
  int v22 = (v2_r1 == 1);
