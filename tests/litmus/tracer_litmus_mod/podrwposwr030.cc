...
label_3:;
  ...
  int v18 = (v10_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r7_0, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r7_0, memory_order_acquire);
