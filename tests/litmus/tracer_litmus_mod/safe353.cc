...
label_3:;
  ...
  int v26 = (v8_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_1, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_1, memory_order_acquire);
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r3_0, memory_order_acquire);
