// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WW+RW+RW+RR+WR+WR+lwsync+lwsync+sync+lwsync+sync+sync.litmus
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r3_0, memory_order_acquire);
