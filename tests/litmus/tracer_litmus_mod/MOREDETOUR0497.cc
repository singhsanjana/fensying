...
lbl_LC00:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v6_r5], 1, memory_order_release);
  ...
  int v16 = (v8_r8 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_2, v16, memory_order_release);
