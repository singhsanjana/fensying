// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/podrwposwr004.litmus
...
label_4:;
  ...
  int v12_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v9_r3], memory_order_acquire);
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], 1, memory_order_release);
  int v14_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v27 = (v8_r1 == 1);
