...
label_4:;
  ...
  int v24 = (v8_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_3_r4_4, v24, memory_order_release);
  int v25 = (v6_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r1_2, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_2_r3_2, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, &atom_3_r4_4, memory_order_acquire);
