...
label_2:;
  ...
  int v17 = (v6_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_4, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_4, memory_order_acquire);
