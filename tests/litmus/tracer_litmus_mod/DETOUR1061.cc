// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1061.litmus
...
label_1:;
  ...
  int v11 = (v2_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_2, v11, memory_order_release);
...
label_2:;
  ...
  int v12 = (v4_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_0, v12, memory_order_release);
