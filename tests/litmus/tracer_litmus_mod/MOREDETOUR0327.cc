...
label_1:;
  ...
  int v25 = (v4_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_1, v25, memory_order_release);
...
label_3:;
  ...
  int v27 = (v8_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_3, v27, memory_order_release);
