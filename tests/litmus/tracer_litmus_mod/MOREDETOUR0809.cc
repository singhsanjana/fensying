// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0809.litmus
...
label_2:;
  ...
  int v22 = (v6_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_2, v22, memory_order_release);
...
label_4:;
  ...
  int v23 = (v10_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_4, v23, memory_order_release);
  int v24 = (v8_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_4, memory_order_acquire);
