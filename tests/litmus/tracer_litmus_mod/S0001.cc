// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S0001.litmus
...
void t1(void *arg){
label_2:;
  int v9_r1 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
