// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO544.litmus
...
lbl_LC01:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v9_r9], 1, memory_order_release);
  ...
  int v19 = (v11_r12 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r12_1, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r12_1, memory_order_acquire);
