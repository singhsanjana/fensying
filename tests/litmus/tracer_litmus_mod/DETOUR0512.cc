...
label_2:;
  ...
  int v15 = (v4_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_2, v15, memory_order_release);
  int v16 = (v8_r8 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_2, memory_order_acquire);
