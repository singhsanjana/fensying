// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO601.litmus
...
label_2:;
  ...
  int v10_r8 = atomic_load_explicit(__LINE__, &vars[3+v7_r7], memory_order_acquire);
  int v11_r10 = v10_r8 ^ v10_r8;
  int v12_r10 = v11_r10 + 1;
  atomic_store_explicit(__LINE__, &vars[0], v12_r10, memory_order_release);
  int v14_r12 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v24 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v24, memory_order_release);
  int v25 = (v14_r12 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r12_1, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__LINE__, &atom_1_r12_1, memory_order_acquire);
