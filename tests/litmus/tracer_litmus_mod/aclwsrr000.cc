...
label_3:;
  ...
  int v19 = (v8_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r5_0, memory_order_acquire);
