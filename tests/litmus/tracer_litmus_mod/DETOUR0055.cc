...
label_1:;
  ...
  int v20 = (v4_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_3, v20, memory_order_release);
...
label_4:;
  ...
  int v22 = (v11_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_3, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_1, memory_order_acquire);
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_0, memory_order_acquire);
