// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1059.litmus
...
label_1:;
  ...
  int v11 = (v2_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_1, v11, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 2);
  int v7 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_1, memory_order_acquire);
