...
lbl_LC00:;
  ...
  int v25 = (v17_r12 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r12_0, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r12_0, memory_order_acquire);
