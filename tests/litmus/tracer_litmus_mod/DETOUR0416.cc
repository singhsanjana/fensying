...
label_1:;
  ...
  int v6_r6 = v5_r6 + 1;
  atomic_store_explicit(__LINE__, &vars[1], v6_r6, memory_order_release);
  int v20 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r3_2, v20, memory_order_release);
  int v21 = (v4_r5 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r5_3, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_0_r5_3, memory_order_acquire);
