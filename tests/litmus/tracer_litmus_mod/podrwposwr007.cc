...
void t3(void *arg){
label_4:;
  int v4_r1 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v5_r3 = v4_r1 ^ v4_r1;
  int v8_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v5_r3], memory_order_acquire);
  ...
  int v24 = (v10_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r8_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r8_1, memory_order_acquire);
