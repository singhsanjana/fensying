...
label_2:;
  ...
  int v18 = (v4_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r6_1, v18, memory_order_release);
  int v19 = (v8_r8 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r8_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_1_r8_0, memory_order_acquire);
