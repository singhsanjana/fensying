...
label_2:;
  ...
  int v8_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v5_r7], memory_order_acquire);
  int v17 = (v2_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_0, v17, memory_order_release);
  int v18 = (v4_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_1, v18, memory_order_release);
  int v19 = (v8_r8 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_1, memory_order_acquire);
