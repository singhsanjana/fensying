...
label_1:;
  ...
  int v25 = (v2_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_0, v25, memory_order_release);
...
label_2:;
  ...
  int v26 = (v4_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_2, v26, memory_order_release);
...
label_3:;
  ...
  int v27 = (v6_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_2, v27, memory_order_release);
...
label_4:;
  ...
  int v28 = (v8_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_4, v28, memory_order_release);
  int v29 = (v12_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_0, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_4, memory_order_acquire);
