// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0560.litmus
...
label_2:;
  ...
  int v21 = (v6_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_1, v21, memory_order_release);
  int v22 = (v8_r7 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_1, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_1, memory_order_acquire);
