...
label_1:;
  ...
  int v22 = (v4_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_0, memory_order_acquire);
