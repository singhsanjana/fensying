...
label_4:;
  ...
  int v24 = (v6_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r1_2, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, &atom_0_r4_0, memory_order_acquire);
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_3_r1_2, memory_order_acquire);
