...
label_4:;
  ...
  int v19 = (v8_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r3_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_1, memory_order_acquire);
