...
label_1:;
  ...
  int v25 = (v2_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r1_3, v25, memory_order_release);
...
label_2:;
  ...
  int v10_r6 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  ...
  int v28 = (v10_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r6_1, v28, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_0_r1_3, memory_order_acquire);
