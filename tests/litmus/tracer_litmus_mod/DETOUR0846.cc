// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0846.litmus
...
label_2:;
  ...
  int v19 = (v4_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_3, v19, memory_order_release);
  int v20 = (v6_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_4, v20, memory_order_release);
  int v21 = (v10_r6 == 0);
