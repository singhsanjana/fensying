// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO068.litmus
...
lbl_LC00:;
  ...
  int v15_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v16_r13 = v15_r12 ^ v15_r12;
  int v19_r14 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v16_r13], memory_order_acquire);
  int v23 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r14_0, memory_order_acquire);
