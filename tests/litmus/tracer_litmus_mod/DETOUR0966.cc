...
label_1:;
  ...
  int v17 = (v4_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_1, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r6_1, memory_order_acquire);
