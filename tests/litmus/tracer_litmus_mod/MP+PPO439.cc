// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO439.litmus
...
lbl_LC00:;
  ...
  int v22 = (v14_r12 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r12_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r12_0, memory_order_acquire);
