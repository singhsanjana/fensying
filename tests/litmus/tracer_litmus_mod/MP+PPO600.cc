// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO600.litmus
...
label_2:;
  ...
  int v9_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[3+v6_r8], memory_order_acquire);
  int v10_r11 = v9_r9 ^ v9_r9;
  int v11_r11 = v10_r11 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v11_r11, memory_order_release);
  int v13_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v23, memory_order_release);
  int v24 = (v13_r13 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r13_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v17 = (v16 == 2);
