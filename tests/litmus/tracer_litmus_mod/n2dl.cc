// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/n2dl.litmus
...
label_1:;
  ...
  int v22 = (v6_r2 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r2_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r2_0, memory_order_acquire);
