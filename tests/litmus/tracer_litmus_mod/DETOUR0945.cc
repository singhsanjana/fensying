// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0945.litmus
...
label_2:;
  ...
  int v19 = (v4_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_1, v19, memory_order_release);
  int v20 = (v6_r7 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_2, v20, memory_order_release);
