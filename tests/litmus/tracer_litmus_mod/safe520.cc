// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe520.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[1+v5_r3], 2, memory_order_release);
  int v24 = (v4_r1 == 1);
