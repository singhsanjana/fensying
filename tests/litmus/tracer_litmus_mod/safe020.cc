// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe020.litmus
...
label_1:;
  ...
  int v22 = (v6_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_1, v22, memory_order_release);
...
label_3:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[2+v9_r3], 1, memory_order_release);
  int v23 = (v8_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_1, memory_order_acquire);
