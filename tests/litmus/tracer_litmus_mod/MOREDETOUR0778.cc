...
label_2:;
  ...
  int v21 = (v5_r7 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_2, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_2, memory_order_acquire);
