// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO640.litmus
...
label_2:;
  ...
  int v7_r8 = v6_r8 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v7_r8, memory_order_release);
  int v9_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v19 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v19, memory_order_release);
  int v20 = (v9_r10 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r10_1, memory_order_acquire);
