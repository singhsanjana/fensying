...
label_2:;
  ...
  int v24 = (v4_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_1, v24, memory_order_release);
...
label_4:;
  ...
  int v26 = (v12_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r7_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r7_0, memory_order_acquire);
