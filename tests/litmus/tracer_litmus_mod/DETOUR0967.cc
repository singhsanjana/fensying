// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0967.litmus
...
label_1:;
  ...
  int v16 = (v2_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_2, v16, memory_order_release);
  int v17 = (v4_r5 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_3, v17, memory_order_release);
...
label_3:;
  ...
  int v18 = (v7_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_0, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_3, memory_order_acquire);
