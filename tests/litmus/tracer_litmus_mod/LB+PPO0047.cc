...
label_2:;
  ...
  int v13_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v14_r9 = v13_r8 ^ v13_r8;
  int v17_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[3+v14_r9], memory_order_acquire);
