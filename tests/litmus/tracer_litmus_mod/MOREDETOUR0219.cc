...
label_2:;
  ...
  int v30 = (v12_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_1, v30, memory_order_release);
...
label_4:;
  ...
  int v31 = (v14_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_1, v31, memory_order_release);
