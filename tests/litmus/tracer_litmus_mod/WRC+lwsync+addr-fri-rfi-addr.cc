// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WRC+lwsync+addr-fri-rfi-addr.litmus
...
label_3:;
  ...
  int v8_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[2+v5_r3], memory_order_acquire);
