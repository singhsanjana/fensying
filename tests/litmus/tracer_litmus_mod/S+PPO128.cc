// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+PPO128.litmus
...
lbl_LC00:;
  ...
  int v9_r7 = v8_r7 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[3], v9_r7, memory_order_release);
