...
label_2:;
  ...
  int v20 = (v4_r4 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_5, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = (v10 == 2);
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_5, memory_order_acquire);
