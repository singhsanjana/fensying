...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v16_r11, memory_order_release);
  ...
  int v26 = (v18_r13 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r13_1, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v22 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r13_1, memory_order_acquire);
