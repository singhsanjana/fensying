// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WW+RR+WW+RW+RR+sync+lwsync+lwsync+sync+lwsync.litmus
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_0, memory_order_acquire);
