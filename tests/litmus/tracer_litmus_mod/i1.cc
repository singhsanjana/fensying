...
label_1:;
  ...
  int v12 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_1, v12, memory_order_release);
...
label_3:;
  ...
  int v14 = (v6_r2 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r2_2, v14, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r2_2, memory_order_acquire);
  int v10_conj = v8 & v9;
