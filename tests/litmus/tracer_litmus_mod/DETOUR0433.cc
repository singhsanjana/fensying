...
lbl_LC00:;
  ...
  int v15 = (v2_r4 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r4_3, v15, memory_order_release);
...
label_2:;
  ...
  int v16 = (v9_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r5_2, v16, memory_order_release);
  int v17 = (v5_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, &atom_0_r4_3, memory_order_acquire);
