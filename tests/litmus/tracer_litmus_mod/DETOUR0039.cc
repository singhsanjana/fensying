...
label_1:;
  ...
  int v15 = (v2_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_2, v15, memory_order_release);
...
label_2:;
  ...
  int v17 = (v9_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r6_2, memory_order_acquire);
