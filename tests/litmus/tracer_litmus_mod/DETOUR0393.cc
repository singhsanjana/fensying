// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0393.litmus
...
label_1:;
  ...
  int v15 = (v2_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_4, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_4, memory_order_acquire);
