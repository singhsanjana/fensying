// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO582.litmus
...
lbl_LC00:;
  ...
  int v9_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v10_r8 = v9_r7 ^ v9_r7;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v10_r8], 1, memory_order_release);
