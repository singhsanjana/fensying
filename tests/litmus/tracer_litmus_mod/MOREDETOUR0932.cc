// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0932.litmus
...
label_4:;
  ...
  int v23 = (v9_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r3_2, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r3_2, memory_order_acquire);
