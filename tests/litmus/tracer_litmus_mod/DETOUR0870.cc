// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0870.litmus
...
label_2:;
  ...
  int v16 = (v5_r7 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_1, v16, memory_order_release);
