// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0547.litmus
...
label_2:;
  ...
  int v14_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[3+v11_r7], memory_order_acquire);
  int v16_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
