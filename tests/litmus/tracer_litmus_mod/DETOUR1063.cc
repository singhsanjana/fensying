// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1063.litmus
...
label_1:;
  ...
  int v16 = (v4_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r6_1, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, &atom_0_r6_1, memory_order_acquire);
