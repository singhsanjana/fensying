...
label_3:;
  ...
  int v17 = (v5_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_3, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_3, memory_order_acquire);
