...
label_1:;
  ...
  int v8 = (v2_r6 == 55);
  atomic_store_explicit(__LINE__, &atom_0_r6_55, v8, memory_order_release);
...
label_2:;
  ...
  int v9 = (v4_r5 == 66);
  atomic_store_explicit(__LINE__, &atom_1_r5_66, v9, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v5 = atomic_load_explicit(__LINE__, &atom_0_r6_55, memory_order_acquire);
  int v6 = atomic_load_explicit(__LINE__, &atom_1_r5_66, memory_order_acquire);
  int v7_conj = v5 & v6;
