...
label_1:;
  ...
  int v15 = (v2_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_4, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_4, memory_order_acquire);
