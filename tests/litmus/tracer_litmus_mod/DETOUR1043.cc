// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1043.litmus
...
label_2:;
  ...
  int v7 = (v2_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_0, v7, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v3 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v4 = (v3 == 2);
  int v5 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_0, memory_order_acquire);
  int v6_conj = v4 & v5;
