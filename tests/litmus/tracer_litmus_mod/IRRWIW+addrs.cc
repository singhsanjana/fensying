// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/IRRWIW+addrs.litmus
...
label_2:;
  ...
  int v18 = (v2_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_2, v18, memory_order_release);
  int v19 = (v6_r4 == 0);
