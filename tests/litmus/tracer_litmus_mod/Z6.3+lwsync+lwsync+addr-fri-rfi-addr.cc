...
label_3:;
  ...
  int v6_r4 = atomic_load_explicit(__LINE__, &vars[3+v3_r3], memory_order_acquire);
  atomic_store_explicit(__LINE__, &vars[3], 1, memory_order_release);
  int v8_r7 = atomic_load_explicit(__LINE__, &vars[3], memory_order_acquire);
  int v9_r8 = v8_r7 ^ v8_r7;
  int v12_r9 = atomic_load_explicit(__LINE__, &vars[0+v9_r8], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  ...
  int v25 = (v8_r7 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r7_1, v25, memory_order_release);
  int v26 = (v12_r9 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r9_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_2_r7_1, memory_order_acquire);
  int v18 = atomic_load_explicit(__LINE__, &atom_2_r9_0, memory_order_acquire);
