// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe351.litmus
...
label_3:;
  ...
  int v24 = (v10_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_1, memory_order_acquire);
