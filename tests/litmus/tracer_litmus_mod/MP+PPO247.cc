// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO247.litmus
...
label_2:;
  ...
  int v14_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v11_r10], memory_order_acquire);
...
lbl_LC00:;
  ...
  int v25 = (v17_r13 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r13_0, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v19 = (v18 == 2);
  int v20 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v21 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r13_0, memory_order_acquire);
