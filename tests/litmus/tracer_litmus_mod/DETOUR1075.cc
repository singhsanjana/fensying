...
label_1:;
  ...
  int v15 = (v2_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_1, v15, memory_order_release);
  int v16 = (v4_r4 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_2, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_2, memory_order_acquire);
