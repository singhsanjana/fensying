...
label_1:;
  ...
  int v22 = (v2_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r1_3, v22, memory_order_release);
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[0+v9_r4], 1, memory_order_release);
  ...
  int v24 = (v8_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r3_2, v24, memory_order_release);
...
void t3(void *arg){
label_4:;
  int v11_r1 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, &atom_0_r1_3, memory_order_acquire);
