// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0813.litmus
...
label_2:;
  ...
  int v25 = (v6_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_1, v25, memory_order_release);
...
label_4:;
  ...
  int v26 = (v10_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_3, v26, memory_order_release);
  int v27 = (v8_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_1, memory_order_acquire);
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_3, memory_order_acquire);
