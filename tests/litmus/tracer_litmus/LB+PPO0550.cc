// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0550.litmus
...
label_2:;
  ...
  int v14_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[2+v11_r6], memory_order_acquire);
  int v16_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
