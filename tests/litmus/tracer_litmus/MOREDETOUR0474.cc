...
label_3:;
  ...
  int v18 = (v8_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v18, memory_order_release);
  int v19 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
