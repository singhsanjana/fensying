// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0598.litmus
...
label_2:;
  ...
  int v17 = (v4_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_1, v17, memory_order_release);
  int v18 = (v6_r4 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_2, v18, memory_order_release);
  int v19 = (v8_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_2, memory_order_acquire);
