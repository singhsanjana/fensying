// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe356.litmus
...
label_3:;
  ...
  int v23 = (v8_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_1, memory_order_acquire);
