// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/podrwposwr058.litmus
...
label_3:;
  ...
  int v17 = (v6_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_1, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r5_1, memory_order_acquire);
