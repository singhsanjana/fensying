// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/CO-S+sync+po.litmus
...
label_2:;
  ...
  int v12 = (v2_r0 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r0_2, v12, memory_order_release);
  int v13 = (v2_r0 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r0_1, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v3 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r0_2, memory_order_acquire);
