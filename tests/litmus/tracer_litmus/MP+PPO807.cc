...
label_2:;
  ...
  int v19 = (v14_r14 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r14_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r14_0, memory_order_acquire);
