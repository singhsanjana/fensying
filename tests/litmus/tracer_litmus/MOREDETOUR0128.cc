// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0128.litmus
...
lbl_LC00:;
  int v11_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
