...
label_2:;
  ...
  int v11_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v8_r8], memory_order_acquire);
  int v15 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v15, memory_order_release);
  int v16 = (v11_r9 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r9_0, v16, memory_order_release);
