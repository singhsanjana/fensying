// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0418.litmus
...
label_1:;
  ...
  int v6_r6 = v5_r6 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[1], v6_r6, memory_order_release);
  int v20 = (v2_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_3, v20, memory_order_release);
  int v21 = (v4_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_4, v21, memory_order_release);
