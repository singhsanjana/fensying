// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO809.litmus
...
lbl_LC00:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v6_r6], 1, memory_order_release);
  int v8_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v9_r10 = v8_r9 ^ v8_r9;
  int v12_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v9_r10], memory_order_acquire);
  int v14_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v18 = (v2_r1 == 1);
