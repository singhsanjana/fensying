// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO946.litmus
...
lbl_LC01:;
  ...
  int v18 = (v10_r9 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r9_1, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r9_1, memory_order_acquire);
