// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/i5.litmus
...
label_2:;
  ...
  int v12_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v9_r8], memory_order_acquire);
  int v22 = (v8_r3 == 1);
