// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe317.litmus
...
label_4:;
  ...
  int v27 = (v10_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r3_1, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r3_1, memory_order_acquire);
