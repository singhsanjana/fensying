...
label_1:;
  ...
  int v25 = (v2_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_3, v25, memory_order_release);
...
label_2:;
  ...
  int v27 = (v8_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_0, v27, memory_order_release);
  int v28 = (v10_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_1, v28, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_3, memory_order_acquire);
