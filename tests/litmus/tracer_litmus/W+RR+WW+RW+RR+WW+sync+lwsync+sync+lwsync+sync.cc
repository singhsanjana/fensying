// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/W+RR+WW+RW+RR+WW+sync+lwsync+sync+lwsync+sync.litmus
...
label_4:;
  ...
  int v25 = (v6_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_1, v25, memory_order_release);
...
label_5:;
  ...
  int v26 = (v8_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_4_r1_1, v26, memory_order_release);
  int v27 = (v10_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_4_r3_0, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = (v11 == 2);
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r1_2, memory_order_acquire);
