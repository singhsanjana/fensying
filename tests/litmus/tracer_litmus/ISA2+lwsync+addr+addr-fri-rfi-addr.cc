...
label_3:;
  ...
  int v9_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[3+v6_r3], memory_order_acquire);
  atomic_store_explicit(__FILE__, __LINE__, &vars[3], 1, memory_order_release);
  int v11_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v12_r8 = v11_r7 ^ v11_r7;
  int v15_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v12_r8], memory_order_acquire);
  int v26 = (v5_r1 == 1);
  ...
  int v28 = (v11_r7 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r7_1, v28, memory_order_release);
  int v29 = (v15_r9 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r9_0, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r7_1, memory_order_acquire);
  int v20 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r9_0, memory_order_acquire);
