// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe216.litmus
...
int user_main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v8 = (v7 == 2);
