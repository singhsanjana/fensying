// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/Z6.4+eieio+lwsync+lwsync.litmus
...
label_3:;
  ...
  int v12 = (v4_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_0, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
  int v9_conj = v7 & v8;
