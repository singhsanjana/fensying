...
label_1:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[3+v5_r7], 1, memory_order_release);

}

void t1(void *arg){
label_2:;
  int v7_r1 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
