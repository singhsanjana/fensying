...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v6_r9], 1, memory_order_release);
  int v11 = (v5_r1 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_0, v11, memory_order_release);
