// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/bclwdww026.litmus
...
label_2:;
  ...
  int v25 = (v6_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_1, v25, memory_order_release);
