...
label_1:;
  ...
  int v26 = (v4_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_1, v26, memory_order_release);
...
label_4:;
  ...
  int v28 = (v8_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_3, v28, memory_order_release);
  int v29 = (v12_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_1, memory_order_acquire);
