// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0721.litmus
...
lbl_LC00:;
  ...
  int v10 = (v5_r6 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_0, v10, memory_order_release);
