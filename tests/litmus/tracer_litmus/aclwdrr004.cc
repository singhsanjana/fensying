...
label_1:;
  ...
  int v18 = (v2_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_1, v18, memory_order_release);
...
label_4:;
  ...
  int v19 = (v4_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_2, v19, memory_order_release);
  int v20 = (v6_r3 == 0);
