// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/SB+rfi-addrs.litmus
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
