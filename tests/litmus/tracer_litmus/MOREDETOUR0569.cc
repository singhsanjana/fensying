// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0569.litmus
...
label_2:;
  ...
  int v18 = (v2_r6 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_3, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 4);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_3, memory_order_acquire);
