...
label_2:;
  ...
  int v24 = (v8_r5 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_4, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_4, memory_order_acquire);
