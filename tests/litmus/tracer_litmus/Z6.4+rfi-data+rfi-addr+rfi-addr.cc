...
label_2:;
  ...
  int v10_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[2+v7_r4], memory_order_acquire);
  int v30 = (v6_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_2, v30, memory_order_release);
  int v31 = (v10_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_0, v31, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
  int v21 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
  int v22 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_1, memory_order_acquire);
  int v23 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r5_0, memory_order_acquire);
