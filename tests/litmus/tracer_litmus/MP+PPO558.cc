// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO558.litmus
...
label_2:;
  ...
  int v18 = (v7_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_1, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r8_1, memory_order_acquire);
