...
label_1:;
  ...
  int v11 = (v2_r5 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_3, v11, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 2);
  int v7 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_3, memory_order_acquire);
