// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO195.litmus
...
lbl_LC00:;
  ...
  int v13_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v14_r11 = v13_r10 ^ v13_r10;
  int v17_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v14_r11], memory_order_acquire);
  int v21 = (v2_r1 == 1);
