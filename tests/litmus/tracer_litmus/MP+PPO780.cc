// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO780.litmus
...
lbl_LC00:;
  ...
  int v19 = (v11_r10 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_1, v19, memory_order_release);
