// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe436.litmus
...
label_3:;
  ...
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v9_r3 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v26 = (v9_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_1, v26, memory_order_release);
