...
label_3:;
  ...
  int v16 = (v4_r2 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r2_2, v16, memory_order_release);
  int v17 = (v6_r1 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r2_2, memory_order_acquire);
