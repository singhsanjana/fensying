// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/2+2W+rfi-addrs.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v6_r4], 1, memory_order_release);
  int v17 = (v5_r3 == 2);
