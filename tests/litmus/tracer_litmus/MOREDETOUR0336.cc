// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0336.litmus
...
label_1:;
  ...
  int v16 = (v2_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_0, memory_order_acquire);
