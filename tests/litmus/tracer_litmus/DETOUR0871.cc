// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0871.litmus
...
label_2:;
  ...
  int v18 = (v7_r7 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_1, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_3, memory_order_acquire);
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_1, memory_order_acquire);
