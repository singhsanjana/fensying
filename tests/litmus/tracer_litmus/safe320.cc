...
label_1:;
  ...
  int v11 = (v6_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_0, v11, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_0, memory_order_acquire);
  int v9_conj = v7 & v8;
