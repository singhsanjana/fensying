// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0507.litmus
...
label_1:;
  ...
  int v18 = (v2_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_3, v18, memory_order_release);
  int v19 = (v4_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_4, v19, memory_order_release);
...
label_4:;
  ...
  int v20 = (v10_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r5_2, v20, memory_order_release);
  int v21 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r5_2, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_1, memory_order_acquire);
