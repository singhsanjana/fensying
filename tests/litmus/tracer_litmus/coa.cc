...
label_1:;
  ...
  int v8 = (v2_r2 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r2_2, v8, memory_order_release);
  int v9 = (v4_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_1, v9, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r3_1, memory_order_acquire);
  int v7_conj = v5 & v6;
