// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0026.litmus
...
label_2:;
  ...
  int v17_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v14_r11], memory_order_acquire);
