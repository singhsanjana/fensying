...
label_4:;
  ...
  int v20 = (v6_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_3, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = (v11 == 5);
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_3, memory_order_acquire);
