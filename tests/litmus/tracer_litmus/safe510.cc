// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe510.litmus
...
label_3:;
  ...
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v12_r3 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v25 = (v10_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
