// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0127.litmus
...
lbl_LC00:;
  ...
  int v11_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v12_r6 = v11_r5 ^ v11_r5;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v12_r6], 1, memory_order_release);
  int v21 = (v6_r1 == 1);
