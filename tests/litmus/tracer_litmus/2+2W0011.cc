// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/2+2W0011.litmus
...
label_2:;
  ...
  int v8_r8 = v7_r8 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v8_r8, memory_order_release);
