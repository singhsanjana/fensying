...
label_2:;
  ...
  int v6_r4 = v5_r4 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v6_r4, memory_order_release);
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], 3, memory_order_release);
  int v22 = (v4_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_3, v22, memory_order_release);
...
label_4:;
  ...
  int v23 = (v10_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_3, v23, memory_order_release);
  int v24 = (v8_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v13 = (v12 == 4);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_3, memory_order_acquire);
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_3, memory_order_acquire);
