// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0937.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v3_r5], 1, memory_order_release);
...
label_3:;
  ...
  int v17 = (v7_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v17, memory_order_release);
  int v18 = (v5_r1 == 1);
