// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+sync+ctrl-detw-addr.litmus
...
lbl_LC00:;
  ...
  int v9_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v6_r6], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v18, memory_order_release);
  int v19 = (v5_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_2, v19, memory_order_release);
  int v20 = (v9_r7 == 0);
