...
label_2:;
  ...
  int v18_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v19_r11 = v18_r10 ^ v18_r10;
  int v22_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v19_r11], memory_order_acquire);
