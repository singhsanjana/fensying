// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO500.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v14_r13], 1, memory_order_release);
  int v16_r16 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v23, memory_order_release);
  int v24 = (v16_r16 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r16_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r16_1, memory_order_acquire);
