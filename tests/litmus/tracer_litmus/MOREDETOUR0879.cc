// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0879.litmus
...
lbl_LC00:;
  ...
  int v7_r6 = v6_r6 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v7_r6, memory_order_release);
  int v15 = (v2_r3 == 2);
