...
label_2:;
  ...
  int v21 = (v10_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r8_1, memory_order_acquire);
