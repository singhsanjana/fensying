// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO900.litmus
...
lbl_LC00:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v8_r7], 1, memory_order_release);
  int v10_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v12_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v19 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v19, memory_order_release);
  int v20 = (v12_r11 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r11_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r11_1, memory_order_acquire);
