// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/n2l3.litmus
...
label_2:;
  ...
  int v12_r2 = atomic_load_explicit(__FILE__, __LINE__, &vars[3+v9_r9], memory_order_acquire);
  int v22 = (v8_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v12_r2 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r2_0, v23, memory_order_release);
