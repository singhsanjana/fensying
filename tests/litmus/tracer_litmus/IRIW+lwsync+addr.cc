// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/IRIW+lwsync+addr.litmus
...
label_4:;
  ...
  int v21 = (v10_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_0, memory_order_acquire);
