// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0286.litmus
...
label_1:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[1+v3_r5], 1, memory_order_release);
  int v23 = (v2_r4 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r4_5, v23, memory_order_release);
...
label_2:;
  ...
  int v24 = (v7_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_4, v24, memory_order_release);
  int v25 = (v5_r1 == 2);
...
label_4:;
  ...
  int v11_r3 = v10_r3 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v11_r3, memory_order_release);
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v13_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v26 = (v13_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r5_2, v26, memory_order_release);
  int v27 = (v9_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_1, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r4_5, memory_order_acquire);
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_4, memory_order_acquire);
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r1_2, memory_order_acquire);
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r5_2, memory_order_acquire);
