...
label_2:;
  ...
  int v26 = (v8_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_0, memory_order_acquire);
