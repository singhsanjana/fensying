...
label_1:;
  ...
  int v20 = (v4_r5 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_3, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_3, memory_order_acquire);
