// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0185.litmus
...
label_1:;
  ...
  int v22 = (v2_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_4, v22, memory_order_release);
...
label_2:;
  ...
  int v9_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  ...
  int v24 = (v9_r7 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_2, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_4, memory_order_acquire);
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_2, memory_order_acquire);
