// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO003.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[4+v10_r10], 1, memory_order_release);
  int v12_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v13_r14 = v12_r13 ^ v12_r13;
  int v16_r15 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v13_r14], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_1, v20, memory_order_release);
  int v21 = (v16_r15 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r15_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r15_0, memory_order_acquire);
