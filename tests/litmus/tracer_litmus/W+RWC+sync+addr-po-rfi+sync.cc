// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/W+RWC+sync+addr-po-rfi+sync.litmus
...
label_2:;
  ...
  int v20 = (v8_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r8_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r8_1, memory_order_acquire);
