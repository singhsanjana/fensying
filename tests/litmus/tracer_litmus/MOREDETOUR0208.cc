// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0208.litmus
...
label_1:;
  ...
  int v17 = (v2_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_2, v17, memory_order_release);
