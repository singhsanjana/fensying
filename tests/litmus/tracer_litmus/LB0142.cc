// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB0142.litmus
...
label_2:;
  ...
  int v12_r6 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
