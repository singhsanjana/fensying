// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0586.litmus
...
label_2:;
  ...
  int v13 = (v4_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r6_2, v13, memory_order_release);
  int v14 = (v6_r7 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_2, memory_order_acquire);
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_0, memory_order_acquire);
  int v10_conj = v8 & v9;
