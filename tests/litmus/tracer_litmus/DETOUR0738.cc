// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0738.litmus
...
label_2:;
  ...
  int v14 = (v5_r7 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_2, v14, memory_order_release);
  int v15 = (v7_r8 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_2, memory_order_acquire);
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r8_0, memory_order_acquire);
  int v11_conj = v9 & v10;
