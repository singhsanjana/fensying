// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0554.litmus
...
label_1:;
  ...
  int v22 = (v2_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_2, v22, memory_order_release);
...
label_2:;
  ...
  int v8_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v5_r6], memory_order_acquire);
  int v23 = (v4_r5 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_5, v23, memory_order_release);
  int v24 = (v8_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_0, v24, memory_order_release);
...
label_3:;
  ...
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v12_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v25 = (v12_r4 == 4);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_2, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_5, memory_order_acquire);
  int v15 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_0, memory_order_acquire);
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_4, memory_order_acquire);
