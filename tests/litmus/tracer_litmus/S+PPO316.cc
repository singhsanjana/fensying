// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+PPO316.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v16_r13, memory_order_release);
  int v24 = (v2_r1 == 1);
