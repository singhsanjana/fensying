// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/IRWIW+eieio+lwsync.litmus
...
label_2:;
  ...
  int v14 = (v2_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r1_2, v14, memory_order_release);
...
label_4:;
  ...
  int v15 = (v4_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_2, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_2, memory_order_acquire);
  int v11_conj = v9 & v10;
