...
label_3:;
  ...
  int v27 = (v8_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_2, v27, memory_order_release);

}

void t3(void *arg){
label_4:;
  int v10_r1 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], 3, memory_order_release);
  atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v12_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v28 = (v12_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_4, v28, memory_order_release);
  int v29 = (v10_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_2, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_0, memory_order_acquire);
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_2, memory_order_acquire);
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_4, memory_order_acquire);
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_2, memory_order_acquire);
