// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/bclwdww004.litmus
...
label_4:;
  ...
  int v23 = (v9_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_1, memory_order_acquire);
