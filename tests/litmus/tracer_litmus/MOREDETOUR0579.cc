// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0579.litmus
...
label_1:;
  ...
  int v19 = (v2_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_2, v19, memory_order_release);
...
label_2:;
  ...
  int v20 = (v4_r3 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_3, v20, memory_order_release);
  int v21 = (v6_r5 == 0);
...
label_4:;
  ...
  int v22 = (v8_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_3, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_3, memory_order_acquire);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &vars[1], memory_order_acquire);
  int v13 = (v12 == 5);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_3, memory_order_acquire);
