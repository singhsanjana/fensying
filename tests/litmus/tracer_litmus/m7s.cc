...
label_2:;
  ...
  int v25 = (v4_r2 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r2_0, v25, memory_order_release);
  int v27 = (v4_r2 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r2_2, v27, memory_order_release);
