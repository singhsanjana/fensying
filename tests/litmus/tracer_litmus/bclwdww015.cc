// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/bclwdww015.litmus
...
label_4:;
  ...
  int v19 = (v8_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_1, memory_order_acquire);
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_0, memory_order_acquire);
