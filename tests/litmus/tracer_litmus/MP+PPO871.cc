// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO871.litmus
...
label_2:;
  ...
  int v22 = (v14_r10 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r10_0, memory_order_acquire);
