// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1115.litmus
...
label_2:;
  ...
  int v8_r6 = v7_r6 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v8_r6, memory_order_release);
  int v17 = (v2_r1 == 1);
