// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+PPO092.litmus
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[2+v7_r6], 1, memory_order_release);
  int v9_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
