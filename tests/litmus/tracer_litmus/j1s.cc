...
label_3:;
  ...
  int v9_r2 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v6_r9], memory_order_acquire);
  int v16 = (v5_r1 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r1_3, v16, memory_order_release);
  int v17 = (v9_r2 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r1_3, memory_order_acquire);
