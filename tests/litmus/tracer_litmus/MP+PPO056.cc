// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO056.litmus
...
label_2:;
  ...
  int v12_r8 = v11_r8 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[3], v12_r8, memory_order_release);
  int v14_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v15_r11 = v14_r10 ^ v14_r10;
  int v18_r12 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v15_r11], memory_order_acquire);
  int v22 = (v2_r1 == 1);
