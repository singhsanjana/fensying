// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/bclwdww025.litmus
...
label_2:;
  ...
  int v22 = (v6_r4 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r4_1, memory_order_acquire);
