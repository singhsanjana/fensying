...
label_3:;
  ...
  int v18 = (v8_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_4, v18, memory_order_release);
  int v19 = (v6_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_4, memory_order_acquire);
