// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+sync+ctrl-rfi-addr.litmus
...
lbl_LC00:;
  ...
  int v16 = (v5_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_1, v16, memory_order_release);
  int v17 = (v9_r7 == 0);
