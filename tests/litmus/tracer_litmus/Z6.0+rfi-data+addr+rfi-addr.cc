...
label_1:;
  ...
  int v24 = (v2_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_1, v24, memory_order_release);
...
label_3:;
  ...
  int v13_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v10_r4], memory_order_acquire);
  int v26 = (v9_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_2, v26, memory_order_release);
  int v27 = (v13_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_0, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r3_1, memory_order_acquire);
