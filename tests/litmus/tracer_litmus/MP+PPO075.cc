...
lbl_LC01:;
  ...
  int v17 = (v12_r10 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r10_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r10_0, memory_order_acquire);
