...
label_3:;
  ...
  int v15 = (v4_r3 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_1, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_1, memory_order_acquire);
  int v11_conj = v9 & v10;
