// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/R0046.litmus
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 2);
  int v7 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_0, memory_order_acquire);
  int v8_conj = v6 & v7;
