// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0253.litmus
...
label_1:;
  ...
  int v19 = (v2_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_4, v19, memory_order_release);
