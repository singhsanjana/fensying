// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1229.litmus
...
label_2:;
  ...
  int v17 = (v4_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_2, v17, memory_order_release);
  int v18 = (v6_r5 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_3, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_3, memory_order_acquire);
