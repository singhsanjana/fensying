// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/podrwposwr053.litmus
...
void t3(void *arg){
label_4:;
  int v2_r1 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  atomic_store_explicit(__FILE__, __LINE__, &vars[4], 1, memory_order_release);
  int v4_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v5_r6 = v4_r5 ^ v4_r5;
  int v8_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v5_r6], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_1, v18, memory_order_release);
  int v19 = (v8_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r7_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r7_0, memory_order_acquire);
