...
lbl_LC00:;
  ...
  int v5_r5 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  ...
  int v21 = (v5_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_2, v21, memory_order_release);
...
label_4:;
  ...
  int v22 = (v9_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_4, v22, memory_order_release);
  int v23 = (v7_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r4_4, memory_order_acquire);
