...
label_2:;
  ...
  int v25 = (v10_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_0, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
