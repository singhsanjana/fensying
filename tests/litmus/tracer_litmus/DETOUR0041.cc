// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0041.litmus
...
label_1:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[2+v5_r7], 1, memory_order_release);
  int v19 = (v2_r3 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r3_0, v19, memory_order_release);
  int v20 = (v4_r6 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_1, v20, memory_order_release);

}

void t1(void *arg){
label_2:;
  int v7_r1 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r6_1, memory_order_acquire);
