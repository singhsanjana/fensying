// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO065.litmus
...
lbl_LC01:;
  ...
  int v12_r11 = atomic_load_explicit(__FILE__, __LINE__, &vars[4], memory_order_acquire);
  int v13_r12 = v12_r11 ^ v12_r11;
  int v16_r13 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v13_r12], memory_order_acquire);
  int v20 = (v2_r1 == 1);
