// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/rfi001.litmus
...
label_1:;
  ...
  int v19 = (v6_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_0, v19, memory_order_release);
...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v9_r4], 1, memory_order_release);
  int v20 = (v8_r3 == 1);
