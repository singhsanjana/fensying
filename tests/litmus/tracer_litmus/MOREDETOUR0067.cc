...
label_4:;
  ...
  int v23 = (v6_r1 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_2, v23, memory_order_release);
  int v24 = (v10_r4 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r4_0, v24, memory_order_release);
