// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0949.litmus
...
label_3:;
  ...
  int v14 = (v4_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v14, memory_order_release);
  int v15 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 4);
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
