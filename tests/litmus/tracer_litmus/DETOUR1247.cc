// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1247.litmus
...
label_2:;
  ...
  int v4_r6 = v3_r6 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v4_r6, memory_order_release);
  int v12 = (v2_r5 == 1);
