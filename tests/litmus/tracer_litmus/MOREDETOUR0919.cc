// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0919.litmus
...
label_3:;
  ...
  int v15 = (v4_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r3_2, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r3_2, memory_order_acquire);
  int v11_conj = v9 & v10;
