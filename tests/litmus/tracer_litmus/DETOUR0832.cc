// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0832.litmus
...
label_2:;
  ...
  int v6_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[0+v3_r7], memory_order_acquire);
  int v13 = (v2_r6 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 2);
  int v9 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r6_2, memory_order_acquire);
