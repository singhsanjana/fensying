// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR1116.litmus
...
label_2:;
  ...
  int v8_r7 = v7_r7 + 1;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], v8_r7, memory_order_release);
  int v17 = (v2_r1 == 1);
