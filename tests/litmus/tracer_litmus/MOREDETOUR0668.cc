// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0668.litmus
...
label_1:;
  ...
  int v19 = (v2_r6 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r6_2, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 5);
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r6_2, memory_order_acquire);
