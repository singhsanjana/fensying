...
lbl_LC00:;
  ...
  int v13_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[2], memory_order_acquire);
  int v14_r8 = v13_r7 ^ v13_r7;
  int v17_r9 = atomic_load_explicit(__FILE__, __LINE__, &vars[3+v14_r8], memory_order_acquire);
