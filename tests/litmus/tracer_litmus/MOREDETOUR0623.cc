// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0623.litmus
...
lbl_LC00:;
  ...
  int v19 = (v6_r4 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r4_4, v19, memory_order_release);
  int v20 = (v9_r5 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_0, v20, memory_order_release);
