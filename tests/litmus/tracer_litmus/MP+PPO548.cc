// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO548.litmus
...
label_2:;
  ...
  int v19 = (v8_r11 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r11_1, v19, memory_order_release);
