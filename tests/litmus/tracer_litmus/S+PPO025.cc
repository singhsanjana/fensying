// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+PPO025.litmus
...
lbl_LC01:;
  ...
  int v12_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v9_r9], memory_order_acquire);
  int v13_r12 = v12_r10 ^ v12_r10;
  atomic_store_explicit(__FILE__, __LINE__, &vars[0+v13_r12], 1, memory_order_release);
  int v18 = (v2_r1 == 1);
