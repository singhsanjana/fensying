// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0658.litmus
...
lbl_LC00:;
  ...
  int v16 = (v5_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_2, v16, memory_order_release);
  int v17 = (v9_r7 == 0);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_0, v17, memory_order_release);
