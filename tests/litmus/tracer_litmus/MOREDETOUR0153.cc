// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0153.litmus
...
label_1:;
  ...
  int v18 = (v2_r1 == 4);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r1_4, v18, memory_order_release);
...
label_3:;
  ...
  int v20 = (v10_r4 == 3);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r4_3, v20, memory_order_release);
  int v21 = (v8_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r1_4, memory_order_acquire);
  int v12 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v13 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
