...
label_4:;
  ...
  int v11_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[5+v8_r3], memory_order_acquire);
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], 1, memory_order_release);
  int v13_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v26 = (v7_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_1, v26, memory_order_release);
  int v27 = (v13_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r8_1, v27, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(__FILE__, __LINE__, &vars[3], memory_order_acquire);
  int v17 = (v16 == 2);
