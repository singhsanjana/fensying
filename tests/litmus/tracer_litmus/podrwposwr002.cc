...
label_2:;
  ...
  int v27 = (v4_r5 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r5_1, v27, memory_order_release);
...
label_4:;
  ...
  int v10_r4 = atomic_load_explicit(__FILE__, __LINE__, &vars[4+v7_r3], memory_order_acquire);
  atomic_store_explicit(__FILE__, __LINE__, &vars[0], 1, memory_order_release);
  int v12_r8 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v28 = (v6_r1 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r1_1, v28, memory_order_release);
  int v29 = (v12_r8 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_3_r8_1, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r5_1, memory_order_acquire);
  int v19 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r1_1, memory_order_acquire);
  int v20 = atomic_load_explicit(__FILE__, __LINE__, &atom_3_r8_1, memory_order_acquire);
