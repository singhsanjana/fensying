...
label_1:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[1+v3_r6], 1, memory_order_release);
  int v23 = (v2_r5 == 5);
  atomic_store_explicit(__FILE__, __LINE__, &atom_0_r5_5, v23, memory_order_release);
...
label_3:;
  ...
  int v26 = (v13_r5 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_2_r5_2, v26, memory_order_release);
  int v27 = (v9_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__FILE__, __LINE__, &atom_0_r5_5, memory_order_acquire);
  ...
  int v17 = atomic_load_explicit(__FILE__, __LINE__, &atom_2_r5_2, memory_order_acquire);
