...
label_2:;
  ...
  atomic_store_explicit(__FILE__, __LINE__, &vars[2+v3_r4], 1, memory_order_release);
  int v5_r7 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  int v12 = (v2_r3 == 2);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r3_2, v12, memory_order_release);
  int v13 = (v5_r7 == 0);
