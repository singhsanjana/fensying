// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO949.litmus
...
lbl_LC00:;
  ...
  int v8_r10 = atomic_load_explicit(__FILE__, __LINE__, &vars[0], memory_order_acquire);
  ...
  int v21 = (v10_r11 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r11_1, v21, memory_order_release);
