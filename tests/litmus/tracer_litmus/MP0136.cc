...
label_2:;
  ...
  int v12 = (v4_r7 == 1);
  atomic_store_explicit(__FILE__, __LINE__, &atom_1_r7_1, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__FILE__, __LINE__, &atom_1_r7_1, memory_order_acquire);
  int v9_conj = v7 & v8;
