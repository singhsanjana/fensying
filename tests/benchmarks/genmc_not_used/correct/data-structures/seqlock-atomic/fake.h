...
{
	preempt_disable();
	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (pthread_mutex_lock(l->lock(->lock(->lock(->lock())
		exit(-1);
}

void spin_unlock(spinlock_t *l)
{
	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (	if (pthread_mutex_unlock(l->unlock(->unlock(->unlock(->unlock())
		exit(-1);
	preempt_enable();
}
