...
if(!((((atomic_load_explicit(&flag5, memory_order_acquire) != 3) && (atomic_load_explicit(&flag5, memory_order_acquire) != 2)) && (atomic_load_explicit(&flag6, memory_order_acquire) != 3)) && (atomic_load_explicit(&flag6, memory_order_acquire) != 2)))return;
;
...
if(!((atomic_load_explicit(&flag6, memory_order_acquire) != 3) && (atomic_load_explicit(&flag6, memory_order_acquire) != 2)))return;
;
...
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if(!(((((((atomic_load_explicit(&flag0, memory_order_acquire) < 3) && (atomic_load_explicit(&flag1, memory_order_acquire) < 3)) && (atomic_load_explicit(&flag2, memory_order_acquire) < 3)) && (atomic_load_explicit(&flag3, memory_order_acquire) < 3)) && (atomic_load_explicit(&flag4, memory_order_acquire) < 3)) && (atomic_load_explicit(&flag5, memory_order_acquire) < 3)) && 1))return;
;
atomic_store_explicit(&flag6, 3, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if (((((atomic_load_explicit(&flag0, memory_order_acquire) == 1) || (atomic_load_explicit(&flag1, memory_order_acquire) == 1)) || (atomic_load_explicit(&flag2, memory_order_acquire) == 1)) || (atomic_load_explicit(&flag3, memory_order_acquire) == 1)) || (atomic_load_explicit(&flag4, memory_order_acquire) == 1) || atomic_load_explicit(&flag5, memory_order_acquire) == 1)
                {
atomic_store_explicit(&flag6, 2, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if(!((((((atomic_load_explicit(&flag0, memory_order_acquire) == 4) || (atomic_load_explicit(&flag1, memory_order_acquire) == 4)) || (atomic_load_explicit(&flag2, memory_order_acquire) == 4)) || (atomic_load_explicit(&flag3, memory_order_acquire) == 4)) || (atomic_load_explicit(&flag4, memory_order_acquire) == 4)) || (atomic_load_explicit(&flag5, memory_order_acquire) == 4)))return;
;
                }
