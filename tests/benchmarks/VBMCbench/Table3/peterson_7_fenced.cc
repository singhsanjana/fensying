...
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(&waiting1, memory_order_acquire) != 1) || (((((((atomic_load_explicit(&level0, memory_order_acquire) < 1) && (atomic_load_explicit(&level2, memory_order_acquire) < 1)) && (atomic_load_explicit(&level3, memory_order_acquire) < 1)) && (atomic_load_explicit(&level4, memory_order_acquire) < 1)) && (atomic_load_explicit(&level5, memory_order_acquire) < 1)) && (atomic_load_explicit(&level6, memory_order_acquire) < 1)) && 1)))return;
;
atomic_store_explicit(&level1, 2, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
atomic_store_explicit(&waiting2, 1, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(&waiting2, memory_order_acquire) != 1) || (((((((atomic_load_explicit(&level0, memory_order_acquire) < 2) && (atomic_load_explicit(&level2, memory_order_acquire) < 2)) && (atomic_load_explicit(&level3, memory_order_acquire) < 2)) && (atomic_load_explicit(&level4, memory_order_acquire) < 2)) && (atomic_load_explicit(&level5, memory_order_acquire) < 2)) && (atomic_load_explicit(&level6, memory_order_acquire) < 2)) && 1)))return;
;
atomic_store_explicit(&level1, 3, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
atomic_store_explicit(&waiting3, 1, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(&waiting3, memory_order_acquire) != 1) || (((((((atomic_load_explicit(&level0, memory_order_acquire) < 3) && (atomic_load_explicit(&level2, memory_order_acquire) < 3)) && (atomic_load_explicit(&level3, memory_order_acquire) < 3)) && (atomic_load_explicit(&level4, memory_order_acquire) < 3)) && (atomic_load_explicit(&level5, memory_order_acquire) < 3)) && (atomic_load_explicit(&level6, memory_order_acquire) < 3)) && 1)))return;
;
atomic_store_explicit(&level1, 4, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
atomic_store_explicit(&waiting4, 1, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(&waiting4, memory_order_acquire) != 1) || (((((((atomic_load_explicit(&level0, memory_order_acquire) < 4) && (atomic_load_explicit(&level2, memory_order_acquire) < 4)) && (atomic_load_explicit(&level3, memory_order_acquire) < 4)) && (atomic_load_explicit(&level4, memory_order_acquire) < 4)) && (atomic_load_explicit(&level5, memory_order_acquire) < 4)) && (atomic_load_explicit(&level6, memory_order_acquire) < 4)) && 1)))return;
;
atomic_store_explicit(&level1, 5, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
atomic_store_explicit(&waiting5, 1, memory_order_release);
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(&waiting5, memory_order_acquire) != 1) || (((((((atomic_load_explicit(&level0, memory_order_acquire) < 5) && (atomic_load_explicit(&level2, memory_order_acquire) < 5)) && (atomic_load_explicit(&level3, memory_order_acquire) < 5)) && (atomic_load_explicit(&level4, memory_order_acquire) < 5)) && (atomic_load_explicit(&level5, memory_order_acquire) < 5)) && (atomic_load_explicit(&level6, memory_order_acquire) < 5)) && 1)))return;
;
...
atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(&waiting5, memory_order_acquire) != 6) || (((((((atomic_load_explicit(&level0, memory_order_acquire) < 5) && (atomic_load_explicit(&level1, memory_order_acquire) < 5)) && (atomic_load_explicit(&level2, memory_order_acquire) < 5)) && (atomic_load_explicit(&level3, memory_order_acquire) < 5)) && (atomic_load_explicit(&level4, memory_order_acquire) < 5)) && (atomic_load_explicit(&level5, memory_order_acquire) < 5)) && 1)))return;
;
