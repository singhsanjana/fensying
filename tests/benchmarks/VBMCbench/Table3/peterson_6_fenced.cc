...
atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(__FILE__, __LINE__, &waiting1, memory_order_acquire) != 3) || ((((((atomic_load_explicit(__FILE__, __LINE__, &level0, memory_order_acquire) < 1) && (atomic_load_explicit(__FILE__, __LINE__, &level1, memory_order_acquire) < 1)) && (atomic_load_explicit(__FILE__, __LINE__, &level2, memory_order_acquire) < 1)) && (atomic_load_explicit(__FILE__, __LINE__, &level4, memory_order_acquire) < 1)) && (atomic_load_explicit(__FILE__, __LINE__, &level5, memory_order_acquire) < 1)) && 1)))return;
;
...
atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(__FILE__, __LINE__, &waiting2, memory_order_acquire) != 3) || ((((((atomic_load_explicit(__FILE__, __LINE__, &level0, memory_order_acquire) < 2) && (atomic_load_explicit(__FILE__, __LINE__, &level1, memory_order_acquire) < 2)) && (atomic_load_explicit(__FILE__, __LINE__, &level2, memory_order_acquire) < 2)) && (atomic_load_explicit(__FILE__, __LINE__, &level4, memory_order_acquire) < 2)) && (atomic_load_explicit(__FILE__, __LINE__, &level5, memory_order_acquire) < 2)) && 1)))return;
;
...
atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(__FILE__, __LINE__, &waiting3, memory_order_acquire) != 3) || ((((((atomic_load_explicit(__FILE__, __LINE__, &level0, memory_order_acquire) < 3) && (atomic_load_explicit(__FILE__, __LINE__, &level1, memory_order_acquire) < 3)) && (atomic_load_explicit(__FILE__, __LINE__, &level2, memory_order_acquire) < 3)) && (atomic_load_explicit(__FILE__, __LINE__, &level4, memory_order_acquire) < 3)) && (atomic_load_explicit(__FILE__, __LINE__, &level5, memory_order_acquire) < 3)) && 1)))return;
;
...
atomic_fetch_add_explicit(__FILE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
if(!((atomic_load_explicit(__FILE__, __LINE__, &waiting4, memory_order_acquire) != 3) || ((((((atomic_load_explicit(__FILE__, __LINE__, &level0, memory_order_acquire) < 4) && (atomic_load_explicit(__FILE__, __LINE__, &level1, memory_order_acquire) < 4)) && (atomic_load_explicit(__FILE__, __LINE__, &level2, memory_order_acquire) < 4)) && (atomic_load_explicit(__FILE__, __LINE__, &level4, memory_order_acquire) < 4)) && (atomic_load_explicit(__FILE__, __LINE__, &level5, memory_order_acquire) < 4)) && 1)))return;
;
