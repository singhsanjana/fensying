...
label_2:;
  ...
  int v17_r15 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v24 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v24, memory_order_release);
  int v25 = (v17_r15 == 1);
  atomic_store_explicit(&atom_1_r15_1, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(&atom_1_r15_1, memory_order_acquire);
