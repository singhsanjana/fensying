// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+data+RDWI+data+WW.litmus
...
label_2:;
  ...
  int v10_r5 = v9_r5 + 1;
  atomic_store_explicit(&vars[2], v10_r5, memory_order_release);
  atomic_store_explicit(&vars[0], 1, memory_order_release);
  int v20 = (v6_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v20, memory_order_release);
  int v21 = (v8_r4 == 2);
  atomic_store_explicit(&atom_1_r4_2, v21, memory_order_release);
