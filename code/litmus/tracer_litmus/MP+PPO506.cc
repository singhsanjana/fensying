// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO506.litmus
...
lbl_LC00:;
  ...
  atomic_store_explicit(&vars[0+v14_r12], 1, memory_order_release);
  int v16_r15 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_release);
  int v24 = (v16_r15 == 1);
  atomic_store_explicit(&atom_1_r15_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(&atom_1_r15_1, memory_order_acquire);
