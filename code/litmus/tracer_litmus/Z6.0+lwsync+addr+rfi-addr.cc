// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/Z6.0+lwsync+addr+rfi-addr.litmus
...
label_3:;
  ...
  int v9_r5 = atomic_load_explicit(&vars[0+v6_r4], memory_order_acquire);
  int v19 = (v5_r3 == 2);
  atomic_store_explicit(&atom_2_r3_2, v19, memory_order_release);
  int v20 = (v9_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v20, memory_order_release);
