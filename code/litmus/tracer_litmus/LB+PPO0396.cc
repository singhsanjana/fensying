// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0396.litmus
...
label_2:;
  ...
  atomic_store_explicit(&vars[3+v10_r8], 1, memory_order_release);
  int v12_r11 = atomic_load_explicit(&vars[3], memory_order_acquire);
