// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0647.litmus
...
lbl_LC00:;
  ...
  int v9_r8 = atomic_load_explicit(&vars[0+v6_r7], memory_order_acquire);
  int v15 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v15, memory_order_release);
  int v16 = (v5_r6 == 2);
  atomic_store_explicit(&atom_1_r6_2, v16, memory_order_release);
  int v17 = (v9_r8 == 0);
  atomic_store_explicit(&atom_1_r8_0, v17, memory_order_release);
