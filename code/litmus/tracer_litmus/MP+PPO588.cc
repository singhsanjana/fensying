...
label_2:;
  ...
  int v8_r6 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v9_r7 = v8_r6 ^ v8_r6;
  atomic_store_explicit(&vars[0+v9_r7], 1, memory_order_release);
  int v11_r10 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v21, memory_order_release);
  int v22 = (v11_r10 == 1);
  atomic_store_explicit(&atom_1_r10_1, v22, memory_order_release);
