// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0544.litmus
...
lbl_LC00:;
  ...
  int v13_r8 = atomic_load_explicit(&vars[3], memory_order_acquire);
  int v14_r9 = v13_r8 ^ v13_r8;
  int v17_r10 = atomic_load_explicit(&vars[4+v14_r9], memory_order_acquire);
  int v19_r12 = atomic_load_explicit(&vars[4], memory_order_acquire);
