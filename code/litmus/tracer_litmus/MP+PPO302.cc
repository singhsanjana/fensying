// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO302.litmus
...
label_2:;
  ...
  atomic_store_explicit(&vars[3+v7_r7], 1, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(&atom_1_r11_0, memory_order_acquire);
