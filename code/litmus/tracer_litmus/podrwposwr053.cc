...
label_4:;
  ...
  int v4_r5 = atomic_load_explicit(&vars[4], memory_order_acquire);
  ...
  int v19 = (v8_r7 == 0);
  atomic_store_explicit(&atom_3_r7_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(&atom_3_r7_0, memory_order_acquire);
