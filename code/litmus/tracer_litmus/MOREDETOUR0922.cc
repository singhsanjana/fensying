// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0922.litmus
...
label_2:;
  ...
  int v23 = (v4_r4 == 0);
  atomic_store_explicit(&atom_1_r4_0, v23, memory_order_release);
...
label_4:;
  ...
  int v25 = (v8_r3 == 2);
  atomic_store_explicit(&atom_3_r3_2, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = (v10 == 3);
  int v12 = atomic_load_explicit(&atom_1_r4_0, memory_order_acquire);
  int v13 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v14 = (v13 == 4);
  int v15 = atomic_load_explicit(&atom_2_r1_2, memory_order_acquire);
  int v16 = atomic_load_explicit(&atom_3_r3_2, memory_order_acquire);
