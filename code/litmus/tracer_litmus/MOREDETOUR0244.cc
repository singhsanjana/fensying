// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0244.litmus
...
label_2:;
  ...
  int v10_r4 = v9_r4 + 1;
  atomic_store_explicit(&vars[0], v10_r4, memory_order_release);
  atomic_store_explicit(&vars[0], 3, memory_order_release);
  int v24 = (v6_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v24, memory_order_release);
  int v25 = (v8_r3 == 2);
  atomic_store_explicit(&atom_1_r3_2, v25, memory_order_release);
