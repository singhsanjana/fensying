// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0029.litmus
...
label_2:;
  ...
  int v14_r9 = atomic_load_explicit(&vars[3], memory_order_acquire);
  int v15_r10 = v14_r9 ^ v14_r9;
  int v18_r11 = atomic_load_explicit(&vars[4+v15_r10], memory_order_acquire);
