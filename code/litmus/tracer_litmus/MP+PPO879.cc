// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO879.litmus
...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v13_r10], 1, memory_order_release);
  int v15_r13 = atomic_load_explicit(&vars[0], memory_order_acquire);
