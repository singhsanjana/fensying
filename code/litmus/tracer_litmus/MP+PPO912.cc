// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO912.litmus
...
label_2:;
  ...
  int v9_r8 = v8_r8 + 1;
  atomic_store_explicit(&vars[0], v9_r8, memory_order_release);
  int v11_r10 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v13_r11 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v20, memory_order_release);
  int v21 = (v13_r11 == 1);
  atomic_store_explicit(&atom_1_r11_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(&atom_1_r11_1, memory_order_acquire);
