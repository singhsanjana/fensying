// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO446.litmus
...
lbl_LC00:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v17_r11 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v21, memory_order_release);
  int v22 = (v17_r11 == 0);
  atomic_store_explicit(&atom_1_r11_0, v22, memory_order_release);
