// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO149.litmus
...
label_2:;
  ...
  int v13_r11 = atomic_load_explicit(&vars[3], memory_order_acquire);
  int v14_r12 = v13_r11 ^ v13_r11;
  int v17_r13 = atomic_load_explicit(&vars[0+v14_r12], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v21, memory_order_release);
  int v22 = (v17_r13 == 0);
  atomic_store_explicit(&atom_1_r13_0, v22, memory_order_release);
