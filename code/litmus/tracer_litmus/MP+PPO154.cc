...
lbl_LC00:;
  ...
  int v13_r10 = atomic_load_explicit(&vars[4+v10_r9], memory_order_acquire);
  int v15_r12 = atomic_load_explicit(&vars[4], memory_order_acquire);
  int v16_r13 = v15_r12 ^ v15_r12;
  int v19_r14 = atomic_load_explicit(&vars[0+v16_r13], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_release);
  int v24 = (v19_r14 == 0);
  atomic_store_explicit(&atom_1_r14_0, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(&atom_1_r14_0, memory_order_acquire);
