// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WW+RW+RR+WW+WR+lwsync+sync+lwsync+sync+sync.litmus
...
label_5:;
  ...
  int v22 = (v8_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(&vars[4], memory_order_acquire);
  int v10 = (v9 == 2);
  ...
  int v14 = atomic_load_explicit(&atom_4_r3_0, memory_order_acquire);
