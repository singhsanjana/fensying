// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO434.litmus
...
lbl_LC00:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v19_r13 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_release);
  int v24 = (v19_r13 == 0);
  atomic_store_explicit(&atom_1_r13_0, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(&atom_1_r13_0, memory_order_acquire);
