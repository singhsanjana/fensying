// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO219.litmus
...
label_2:;
  ...
  int v12_r12 = atomic_load_explicit(&vars[4+v9_r11], memory_order_acquire);
  int v13_cmpeq = (v12_r12 == v12_r12);
  if (v13_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v15_r14 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v19 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v19, memory_order_release);
  int v20 = (v15_r14 == 0);
  atomic_store_explicit(&atom_1_r14_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(&atom_1_r14_0, memory_order_acquire);
