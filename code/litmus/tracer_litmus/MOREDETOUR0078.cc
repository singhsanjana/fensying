// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0078.litmus
...
label_1:;
  ...
  atomic_store_explicit(&vars[2+v3_r5], 1, memory_order_release);
...
label_3:;
  ...
  int v21 = (v7_r1 == 3);
  atomic_store_explicit(&atom_2_r1_3, v21, memory_order_release);
  int v22 = (v11_r4 == 0);
