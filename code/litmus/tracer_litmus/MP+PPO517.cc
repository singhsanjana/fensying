// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO517.litmus
...
label_2:;
  ...
  int v11_r9 = atomic_load_explicit(&vars[3+v8_r8], memory_order_acquire);
  int v12_r11 = v11_r9 ^ v11_r9;
  atomic_store_explicit(&vars[0+v12_r11], 1, memory_order_release);
  int v14_r14 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v21, memory_order_release);
  int v22 = (v14_r14 == 1);
  atomic_store_explicit(&atom_1_r14_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(&atom_1_r14_1, memory_order_acquire);
