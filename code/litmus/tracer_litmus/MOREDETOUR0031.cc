// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0031.litmus
...
label_2:;
  ...
  int v18 = (v4_r4 == 3);
  atomic_store_explicit(&atom_1_r4_3, v18, memory_order_release);
  int v19 = (v2_r1 == 1);
...
label_3:;
  ...
  int v20 = (v6_r1 == 4);
  atomic_store_explicit(&atom_2_r1_4, v20, memory_order_release);
  int v21 = (v10_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(&atom_1_r4_3, memory_order_acquire);
  int v12 = atomic_load_explicit(&atom_1_r1_1, memory_order_acquire);
  int v13 = atomic_load_explicit(&atom_2_r1_4, memory_order_acquire);
