...
lbl_LC00:;
  ...
  atomic_store_explicit(&vars[0+v6_r7], 1, memory_order_release);
  int v8_r10 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v10_r11 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
