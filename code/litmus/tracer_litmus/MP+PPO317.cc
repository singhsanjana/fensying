...
label_2:;
  ...
  int v12_r9 = v11_r9 + 1;
  atomic_store_explicit(&vars[4], v12_r9, memory_order_release);
  int v14_r11 = atomic_load_explicit(&vars[4], memory_order_acquire);
  int v15_cmpeq = (v14_r11 == v14_r11);
  if (v15_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v17_r12 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
