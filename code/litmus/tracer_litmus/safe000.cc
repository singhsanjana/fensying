// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/safe000.litmus
...
label_3:;
  ...
  atomic_store_explicit(&vars[2+v9_r3], 1, memory_order_release);
  int v23 = (v8_r1 == 2);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(&atom_0_r4_0, memory_order_acquire);
