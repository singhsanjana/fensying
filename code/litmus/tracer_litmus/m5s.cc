...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v17 = (v16 == 1);
  int v18 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v19 = (v18 == 2);
  ...
  int v26 = (v25 == 2);
  int v27 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v28 = (v27 == 1);
  ...
  int v34 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v35 = (v34 == 2);
  int v36 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v37 = (v36 == 2);
  ...
  int v43 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v44 = (v43 == 1);
  int v45 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v46 = (v45 == 1);
  ...
  int v52 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v53 = (v52 == 1);
  int v54 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v55 = (v54 == 2);
