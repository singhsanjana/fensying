// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0134.litmus
...
label_2:;
  ...
  int v11_r8 = atomic_load_explicit(&vars[2], memory_order_acquire);
  int v12_r9 = v11_r8 ^ v11_r8;
  atomic_store_explicit(&vars[3+v12_r9], 1, memory_order_release);
