// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/Z6.2+rfi-data+addr+addr.litmus
...
label_3:;
  ...
  atomic_store_explicit(&vars[0+v10_r3], 1, memory_order_release);
  int v21 = (v9_r1 == 1);
