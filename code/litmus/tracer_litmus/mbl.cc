// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/mbl.litmus
...
int user_main(int argc, char **argv){
  ...
  int v3 = atomic_load_explicit(&atom_1_r2_1, memory_order_acquire);
  ...
  int v17 = atomic_load_explicit(&atom_1_r2_2, memory_order_acquire);
