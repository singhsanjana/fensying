// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO573.litmus
...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v15_r11], 1, memory_order_release);
  int v17_r14 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v24 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v24, memory_order_release);
  int v25 = (v17_r14 == 1);
  atomic_store_explicit(&atom_1_r14_1, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(&atom_1_r14_1, memory_order_acquire);
