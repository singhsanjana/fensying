// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/LB+PPO0080.litmus
...
lbl_LC00:;
  ...
  int v15_r8 = atomic_load_explicit(&vars[3+v12_r7], memory_order_acquire);
  int v16_r10 = v15_r8 ^ v15_r8;
  atomic_store_explicit(&vars[4+v16_r10], 1, memory_order_release);
