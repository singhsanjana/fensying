...
label_1:;
  ...
  int v29 = (v6_r2 == 0);
  atomic_store_explicit(&atom_0_r2_0, v29, memory_order_release);
  int v30 = (v2_r1 == 2);
  atomic_store_explicit(&atom_0_r1_2, v30, memory_order_release);
...
label_2:;
  ...
  int v31 = (v8_r1 == 2);
  atomic_store_explicit(&atom_1_r1_2, v31, memory_order_release);
  int v32 = (v12_r2 == 0);
  atomic_store_explicit(&atom_1_r2_0, v32, memory_order_release);
  int v33 = (v8_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(&atom_1_r2_0, memory_order_acquire);
  int v21_conj = v19 & v20;
  int v22 = atomic_load_explicit(&atom_1_r1_1, memory_order_acquire);
  int v23 = atomic_load_explicit(&atom_1_r2_0, memory_order_acquire);
