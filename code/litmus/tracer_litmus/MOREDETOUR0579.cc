...
label_4:;
  ...
  int v22 = (v8_r1 == 3);
  atomic_store_explicit(&atom_3_r1_3, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(&atom_1_r3_3, memory_order_acquire);
  int v11 = atomic_load_explicit(&atom_1_r5_0, memory_order_acquire);
  int v12 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v13 = (v12 == 5);
  int v14 = atomic_load_explicit(&atom_3_r1_3, memory_order_acquire);
