...
label_2:;
  ...
  int v13_r12 = atomic_load_explicit(&vars[4+v10_r11], memory_order_acquire);
  int v14_cmpeq = (v13_r12 == v13_r12);
  if (v14_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v16_r14 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(&vars[3], memory_order_acquire);
  int v18 = (v17 == 2);
