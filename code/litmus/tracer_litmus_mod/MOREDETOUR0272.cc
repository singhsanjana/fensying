...
label_1:;
  ...
  int v25 = (v2_r1 == 4);
  atomic_store_explicit(__LINE__, &atom_0_r1_4, v25, memory_order_release);
...
label_2:;
  ...
  int v27 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r3_0, v27, memory_order_release);
...
label_3:;
  ...
  int v28 = (v10_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r3_2, v28, memory_order_release);

}

void t3(void *arg){
label_4:;
  int v12_r1 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  atomic_store_explicit(__LINE__, &vars[0], 3, memory_order_release);
  int v29 = (v12_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r1_2, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_0_r1_4, memory_order_acquire);
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_2_r3_2, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v18 = (v17 == 4);
  int v19 = atomic_load_explicit(__LINE__, &atom_3_r1_2, memory_order_acquire);
