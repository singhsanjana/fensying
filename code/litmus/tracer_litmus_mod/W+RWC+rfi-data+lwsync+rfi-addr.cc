...
label_1:;
  ...
  int v24 = (v2_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r3_1, v24, memory_order_release);
...
label_2:;
  ...
  int v26 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r3_0, v26, memory_order_release);
...
label_3:;
  ...
  int v27 = (v10_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r3_1, v27, memory_order_release);
  int v28 = (v14_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r5_0, v28, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_1_r3_0, memory_order_acquire);
  int v18 = atomic_load_explicit(__LINE__, &atom_2_r3_1, memory_order_acquire);
  int v19 = atomic_load_explicit(__LINE__, &atom_2_r5_0, memory_order_acquire);
