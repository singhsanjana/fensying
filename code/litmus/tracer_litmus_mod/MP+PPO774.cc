// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO774.litmus
...
label_2:;
  ...
  int v19 = (v11_r11 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r11_1, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r11_1, memory_order_acquire);
