// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0719.litmus
...
label_2:;
  ...
  int v10 = (v5_r7 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r7_0, v10, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(__LINE__, &atom_1_r7_0, memory_order_acquire);
  int v8_conj = v6 & v7;
