...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[0+v3_r5], 1, memory_order_release);
  int v5_r8 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v13 = (v5_r8 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r8_2, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = (v8 == 3);
  int v10 = atomic_load_explicit(__LINE__, &atom_1_r8_2, memory_order_acquire);
  int v11_conj = v9 & v10;
