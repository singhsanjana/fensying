...
label_2:;
  ...
  int v21 = (v6_r6 == 3);
  atomic_store_explicit(__LINE__, &atom_1_r6_3, v21, memory_order_release);
...
label_3:;
  ...
  int v22 = (v8_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r3_2, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_1_r6_3, memory_order_acquire);
