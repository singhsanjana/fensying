...
label_1:;
  ...
  int v22 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r1_2, v22, memory_order_release);
...
lbl_LC00:;
  ...
  int v13_r6 = atomic_load_explicit(__LINE__, &vars[0+v10_r5], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r6_0, memory_order_acquire);
