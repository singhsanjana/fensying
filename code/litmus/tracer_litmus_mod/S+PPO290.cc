// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/S+PPO290.litmus
...
lbl_LC00:;
  ...
  int v12_r11 = atomic_load_explicit(__LINE__, &vars[4+v9_r10], memory_order_acquire);
  int v13_r13 = v12_r11 ^ v12_r11;
  int v14_r13 = v13_r13 + 1;
  atomic_store_explicit(__LINE__, &vars[0], v14_r13, memory_order_release);
  int v19 = (v2_r1 == 1);
