...
label_2:;
  ...
  int v21 = (v4_r5 == 4);
  atomic_store_explicit(__LINE__, &atom_1_r5_4, v21, memory_order_release);
  int v22 = (v6_r6 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r6_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, &atom_1_r5_4, memory_order_acquire);
