...
label_2:;
  ...
  int v13 = (v4_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r3_1, v13, memory_order_release);
  int v14 = (v6_r6 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r6_0, v14, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__LINE__, &atom_1_r3_1, memory_order_acquire);
