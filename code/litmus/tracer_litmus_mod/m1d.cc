...
label_2:;
  ...
  int v12_r1 = atomic_load_explicit(__LINE__, &vars[0+v9_r9], memory_order_acquire);
  int v22 = (v12_r1 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r1_0, v22, memory_order_release);
  int v23 = (v8_r2 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r2_2, v23, memory_order_release);
