...
lbl_LC00:;
  ...
  int v25 = (v5_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r3_0, v25, memory_order_release);
...
label_3:;
  ...
  int v26 = (v7_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r3_2, v26, memory_order_release);
...
label_4:;
  ...
  int v27 = (v11_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_3_r4_4, v27, memory_order_release);
  int v28 = (v9_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r1_2, v28, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_3_r4_4, memory_order_acquire);
  int v18 = atomic_load_explicit(__LINE__, &atom_3_r1_2, memory_order_acquire);
