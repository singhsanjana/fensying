...
label_2:;
  ...
  int v18_r12 = atomic_load_explicit(__LINE__, &vars[4+v15_r11], memory_order_acquire);
  int v19_cmpeq = (v18_r12 == v18_r12);
  if (v19_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(__LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v21_r14 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v25 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r1_1, v25, memory_order_release);
  int v26 = (v21_r14 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r14_0, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v23 = atomic_load_explicit(__LINE__, &atom_1_r14_0, memory_order_acquire);
