...
label_1:;
  ...
  int v4_r7 = v3_r7 + 1;
  atomic_store_explicit(__LINE__, &vars[2], v4_r7, memory_order_release);
  int v16 = (v2_r6 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r6_2, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, &atom_0_r6_2, memory_order_acquire);
