...
label_1:;
  ...
  int v24 = (v4_r5 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r5_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, &atom_0_r5_1, memory_order_acquire);
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_3_r3_0, memory_order_acquire);
