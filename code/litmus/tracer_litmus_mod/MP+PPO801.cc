// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO801.litmus
...
label_2:;
  ...
  int v20 = (v12_r9 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r9_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r9_1, memory_order_acquire);
