// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO294.litmus
...
lbl_LC00:;
  ...
  int v18 = (v13_r12 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r12_0, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r12_0, memory_order_acquire);
