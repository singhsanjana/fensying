...
label_1:;
  ...
  int v14 = (v2_r6 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r6_2, v14, memory_order_release);
...
label_2:;
  ...
  int v15 = (v4_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_1_r1_3, v15, memory_order_release);
  int v16 = (v8_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r4_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, &atom_1_r1_3, memory_order_acquire);
