...
label_3:;
  ...
  int v20 = (v6_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_2_r1_3, v20, memory_order_release);
  int v21 = (v10_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r4_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_2_r1_3, memory_order_acquire);
