...
label_2:;
  ...
  int v23 = (v8_r7 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r7_2, v23, memory_order_release);
...
label_3:;
  ...
  int v24 = (v10_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r3_2, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r7_2, memory_order_acquire);
