...
label_2:;
  ...
  int v18 = (v6_r4 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r4_2, v18, memory_order_release);
  int v19 = (v8_r5 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r5_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, &atom_1_r4_2, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, &atom_1_r5_0, memory_order_acquire);
