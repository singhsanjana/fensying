...
label_2:;
  ...
  int v28 = (v8_r7 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r7_0, v28, memory_order_release);
...
label_4:;
  ...
  int v30 = (v16_r8 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r8_1, v30, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__LINE__, &atom_1_r7_0, memory_order_acquire);
  int v21 = atomic_load_explicit(__LINE__, &atom_3_r1_1, memory_order_acquire);
  int v22 = atomic_load_explicit(__LINE__, &atom_3_r8_1, memory_order_acquire);
