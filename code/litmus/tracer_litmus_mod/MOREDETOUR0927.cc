...
label_2:;
  ...
  int v18 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r5_2, v18, memory_order_release);
...
label_4:;
  ...
  int v19 = (v6_r4 == 4);
  atomic_store_explicit(__LINE__, &atom_3_r4_4, v19, memory_order_release);
  int v20 = (v4_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_3_r1_2, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 5);
  int v11 = atomic_load_explicit(__LINE__, &atom_1_r5_2, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, &atom_3_r4_4, memory_order_acquire);
