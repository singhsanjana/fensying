// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0843.litmus
...
lbl_LC00:;
  ...
  int v21 = (v4_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r3_2, v21, memory_order_release);
...
label_4:;
  ...
  int v22 = (v9_r4 == 3);
  atomic_store_explicit(__LINE__, &atom_3_r4_3, v22, memory_order_release);
  int v23 = (v7_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r1_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_1_r3_2, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, &atom_3_r4_3, memory_order_acquire);
