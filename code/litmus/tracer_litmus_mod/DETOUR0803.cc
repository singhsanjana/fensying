...
label_2:;
  ...
  int v23 = (v8_r7 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r7_1, v23, memory_order_release);
  int v24 = (v10_r8 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r8_2, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r8_2, memory_order_acquire);
