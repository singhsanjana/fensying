// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/WW+RW+RR+WR+WW+WR+lwsync+sync+lwsync+sync+sync+sync.litmus
...
label_3:;
  ...
  atomic_fetch_add_explicit(__LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v6_r3 = atomic_load_explicit(__LINE__, &vars[3], memory_order_acquire);
  int v24 = (v4_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r1_1, v24, memory_order_release);
  int v25 = (v6_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r3_0, v25, memory_order_release);
...
label_4:;
  ...
  atomic_fetch_add_explicit(__LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v8_r3 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v26 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_3_r3_0, v26, memory_order_release);
...
void t5(void *arg){
label_6:;
  atomic_store_explicit(__LINE__, &vars[5], 2, memory_order_release);
  atomic_fetch_add_explicit(__LINE__, &__fence_var, 0, memory_order_acq_rel);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, &vars[5], memory_order_acquire);
  int v12 = (v11 == 2);
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_3_r3_0, memory_order_acquire);
