...
label_2:;
  ...
  int v22 = (v8_r7 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r7_1, v22, memory_order_release);
  int v23 = (v12_r9 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r9_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r9_0, memory_order_acquire);
