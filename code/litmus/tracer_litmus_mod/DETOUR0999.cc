...
label_1:;
  ...
  int v6_r5 = v5_r5 + 1;
  atomic_store_explicit(__LINE__, &vars[1], v6_r5, memory_order_release);
  int v17 = (v2_r3 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r3_1, v17, memory_order_release);
  int v18 = (v4_r4 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r4_2, v18, memory_order_release);
...
label_3:;
  ...
  int v19 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r3_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__LINE__, &atom_0_r3_1, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, &atom_0_r4_2, memory_order_acquire);
