// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO097.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[2+v5_r5], 1, memory_order_release);
  atomic_store_explicit(__LINE__, &vars[2], 2, memory_order_release);
  int v7_r9 = atomic_load_explicit(__LINE__, &vars[2], memory_order_acquire);
  int v8_r10 = v7_r9 ^ v7_r9;
  int v11_r11 = atomic_load_explicit(__LINE__, &vars[0+v8_r10], memory_order_acquire);
  int v21 = (v2_r1 == 1);
