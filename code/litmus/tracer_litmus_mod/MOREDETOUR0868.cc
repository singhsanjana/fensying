...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[0+v5_r6], 1, memory_order_release);
  int v21 = (v4_r5 == 5);
  atomic_store_explicit(__LINE__, &atom_1_r5_5, v21, memory_order_release);
...
label_3:;
  ...
  atomic_fetch_add_explicit(__LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v9_r4 = atomic_load_explicit(__LINE__, &vars[1], memory_order_acquire);
  int v22 = (v9_r4 == 4);
