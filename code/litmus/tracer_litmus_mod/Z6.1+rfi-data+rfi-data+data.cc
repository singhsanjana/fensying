...
label_1:;
  ...
  int v24 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r3_2, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = (v15 == 2);
  int v17 = atomic_load_explicit(__LINE__, &atom_0_r3_2, memory_order_acquire);
  int v18 = atomic_load_explicit(__LINE__, &atom_1_r3_2, memory_order_acquire);
