...
label_1:;
  ...
  atomic_store_explicit(__LINE__, &vars[2+v5_r6], 1, memory_order_release);
  int v19 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_0_r3_0, v19, memory_order_release);
  int v20 = (v4_r5 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r5_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, &atom_0_r5_1, memory_order_acquire);
