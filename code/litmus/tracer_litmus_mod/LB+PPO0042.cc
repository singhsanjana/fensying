...
lbl_LC00:;
  ...
  int v13_r7 = atomic_load_explicit(__LINE__, &vars[3+v10_r6], memory_order_acquire);
  int v15_r9 = atomic_load_explicit(__LINE__, &vars[3], memory_order_acquire);
  int v16_r10 = v15_r9 ^ v15_r9;
  int v19_r11 = atomic_load_explicit(__LINE__, &vars[4+v16_r10], memory_order_acquire);
