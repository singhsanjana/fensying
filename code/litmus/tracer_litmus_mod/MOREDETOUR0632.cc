...
label_1:;
  ...
  int v21 = (v2_r5 == 4);
  atomic_store_explicit(__LINE__, &atom_0_r5_4, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = (v11 == 2);
  int v13 = atomic_load_explicit(__LINE__, &atom_0_r5_4, memory_order_acquire);
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_2_r3_0, memory_order_acquire);
