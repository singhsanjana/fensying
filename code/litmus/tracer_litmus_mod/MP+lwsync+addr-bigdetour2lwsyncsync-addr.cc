...
label_2:;
  ...
  int v8_r6 = atomic_load_explicit(__LINE__, &vars[3], memory_order_acquire);
  ...
  int v24 = (v12_r9 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r9_0, v24, memory_order_release);
  int v25 = (v6_r4 == 0);
  atomic_store_explicit(__LINE__, &atom_1_r4_0, v25, memory_order_release);
  int v26 = (v8_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r6_1, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r6_1, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
  int v18 = (v17 == 2);
