// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0609.litmus
...
label_2:;
  ...
  int v6_r5 = v5_r5 + 1;
  atomic_store_explicit(__LINE__, &vars[0], v6_r5, memory_order_release);
  int v8_r7 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v16 = (v8_r7 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r7_2, v16, memory_order_release);
