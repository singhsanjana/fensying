// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO046.litmus
...
lbl_LC00:;
  ...
  int v11_r9 = v10_r9 + 1;
  atomic_store_explicit(__LINE__, &vars[4], v11_r9, memory_order_release);
  int v13_r11 = atomic_load_explicit(__LINE__, &vars[4], memory_order_acquire);
