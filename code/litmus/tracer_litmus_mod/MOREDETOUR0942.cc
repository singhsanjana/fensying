// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MOREDETOUR0942.litmus
...
label_2:;
  ...
  int v6_r4 = v5_r4 + 1;
  atomic_store_explicit(__LINE__, &vars[0], v6_r4, memory_order_release);
...
label_4:;
  ...
  int v23 = (v10_r4 == 3);
  atomic_store_explicit(__LINE__, &atom_3_r4_3, v23, memory_order_release);
  int v24 = (v8_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r1_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_3_r4_3, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, &atom_3_r1_1, memory_order_acquire);
