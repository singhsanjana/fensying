...
void t5(void *arg){
label_6:;
  int v10_r1 = atomic_load_explicit(__LINE__, &vars[5], memory_order_acquire);
  atomic_fetch_add_explicit(__LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v12_r3 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v28 = (v10_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_5_r1_1, v28, memory_order_release);
  int v29 = (v12_r3 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_5_r1_1, memory_order_acquire);
