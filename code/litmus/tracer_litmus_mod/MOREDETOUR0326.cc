...
label_1:;
  ...
  int v20 = (v2_r6 == 2);
  atomic_store_explicit(__LINE__, &atom_0_r6_2, v20, memory_order_release);
...
label_2:;
  ...
  int v21 = (v4_r1 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r1_2, v21, memory_order_release);
...
label_3:;
  ...
  int v22 = (v6_r1 == 4);
  atomic_store_explicit(__LINE__, &atom_2_r1_4, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, &atom_0_r6_2, memory_order_acquire);
  ...
  int v14 = (v13 == 2);
  int v15 = atomic_load_explicit(__LINE__, &atom_2_r1_4, memory_order_acquire);
