// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/DETOUR0417.litmus
...
label_1:;
  ...
  int v6_r7 = v5_r7 + 1;
  atomic_store_explicit(__LINE__, &vars[2], v6_r7, memory_order_release);
  int v19 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_0_r3_0, v19, memory_order_release);
  int v20 = (v4_r6 == 1);
  atomic_store_explicit(__LINE__, &atom_0_r6_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, &atom_0_r6_1, memory_order_acquire);
