...
label_2:;
  ...
  int v27 = (v4_r5 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r5_1, v27, memory_order_release);
...
label_4:;
  ...
  int v29 = (v12_r8 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r8_1, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_1_r5_1, memory_order_acquire);
