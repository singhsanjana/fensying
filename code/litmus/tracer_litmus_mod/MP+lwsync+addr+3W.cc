...
label_2:;
  ...
  int v26 = (v6_r4 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r4_1, v26, memory_order_release);
  int v27 = (v6_r4 == 2);
  atomic_store_explicit(__LINE__, &atom_1_r4_2, v27, memory_order_release);
...
label_3:;
  ...
  int v23 = (v8_r3 == 2);
  atomic_store_explicit(__LINE__, &atom_2_r3_2, v23, memory_order_release);
...
label_4:;
  ...
  int v24 = (v10_r3 == 3);
  atomic_store_explicit(__LINE__, &atom_3_r3_3, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, &atom_2_r3_2, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, &atom_3_r3_3, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, &atom_1_r4_0, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r4_1, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, &atom_1_r4_2, memory_order_acquire);
