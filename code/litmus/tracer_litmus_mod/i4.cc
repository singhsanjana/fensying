...
label_3:;
  ...
  int v16 = (v2_r1 == 4);
  atomic_store_explicit(__LINE__, &atom_2_r1_4, v16, memory_order_release);
  int v17 = (v4_r2 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r2_1, v17, memory_order_release);
...
label_4:;
  ...
  int v19 = (v8_r2 == 3);
  atomic_store_explicit(__LINE__, &atom_3_r2_3, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, &atom_2_r1_4, memory_order_acquire);
  int v10 = atomic_load_explicit(__LINE__, &atom_2_r2_1, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, &atom_3_r1_2, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, &atom_3_r2_3, memory_order_acquire);
