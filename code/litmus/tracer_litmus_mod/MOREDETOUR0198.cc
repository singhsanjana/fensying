...
label_1:;
  ...
  int v23 = (v2_r1 == 3);
  atomic_store_explicit(__LINE__, &atom_0_r1_3, v23, memory_order_release);
...
label_2:;
  ...
  int v25 = (v10_r5 == 1);
  atomic_store_explicit(__LINE__, &atom_1_r5_1, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, &atom_1_r5_1, memory_order_acquire);
