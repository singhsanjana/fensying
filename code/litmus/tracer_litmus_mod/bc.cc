...
label_2:;
  ...
  int v6_r2 = atomic_load_explicit(__LINE__, &vars[0+v3_r7], memory_order_acquire);
  int v20 = (v2_r1 == 1);
...
label_3:;
  ...
  int v12_r2 = atomic_load_explicit(__LINE__, &vars[0+v9_r7], memory_order_acquire);
  int v22 = (v8_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_2_r1_1, v22, memory_order_release);
  int v23 = (v12_r2 == 0);
  atomic_store_explicit(__LINE__, &atom_2_r2_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, &atom_2_r2_0, memory_order_acquire);
