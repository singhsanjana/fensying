// /Users/tuan-phongngo/WETA/litmus_benchmarks/gen-litmuts/power-tests/MP+PPO513.litmus
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, &vars[0+v11_r9], 1, memory_order_release);
