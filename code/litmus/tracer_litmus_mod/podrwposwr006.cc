...
label_1:;
  ...
  int v23 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, &atom_0_r3_0, v23, memory_order_release);
...
label_4:;
  ...
  int v10_r4 = atomic_load_explicit(__LINE__, &vars[4+v7_r3], memory_order_acquire);
  atomic_store_explicit(__LINE__, &vars[0], 1, memory_order_release);
  int v12_r8 = atomic_load_explicit(__LINE__, &vars[0], memory_order_acquire);
  int v25 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r1_1, v25, memory_order_release);
  int v26 = (v12_r8 == 1);
  atomic_store_explicit(__LINE__, &atom_3_r8_1, v26, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, &atom_3_r8_1, memory_order_acquire);
