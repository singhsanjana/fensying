...
\newcommand{\hl}[1]{\hypertarget{#1}{\textcolor{darkgray}{\texttt{#1}}}\xspace} % hyperlink target
...
\newcommand{\stfence}{\textcolor{black}{Strong-\ourtechniquename}\xspace}
\newcommand{\wkfence}{\textcolor{black}{Weak-\ourtechniquename}\xspace}
...
\newcommand{\sfences}{\overline{\fences}\xspace}
...
\newcommand{\ordsfences}[1]{\overline{\ordfences{#1}}\xspace}
% cycles
...
\newcommand{\nrf}[3]{\nreln{\textbf{\textcolor{PineGreen}{rf}}}{#1}{#2}{#3}\xspace} 
\newcommand{\dob}[3]{\reln{\textbf{\textcolor{Mulberry}{dob}}}{#1}{#2}{#3}\xspace}
\newcommand{\ndob}[3]{\nreln{\textbf{\textcolor{Mulberry}{dob}}}{#1}{#2}{#3}\xspace}
\newcommand{\sw}[3]{\reln{\textbf{\textcolor{Magenta}{sw}}}{#1}{#2}{#3}\xspace}
\newcommand{\nsw}[3]{\nreln{\textbf{\textcolor{Magenta}{sw}}}{#1}{#2}{#3}\xspace}
...
\newcommand{\nso}[3]{\nreln{\textbf{\textcolor{Mahogany}{so}}}{#1}{#2}{#3}\xspace} %sc
...
\newcommand{\frsc}[3]{\reln{\textbf{\textcolor{RoyalPurple}{\onsc{fr}}}}{#1}{#2}{#3}\xspace} %rb/fr
\newcommand{\nfrsc}[3]{#2\onsc{\nrightarrow^{{\bf\textcolor{RoyalPurple}{fr}}}_{#1}}#3\xspace}
\newcommand{\rfinv}[3]{#2 \rightarrow^{ \textcolor{PineGreen}{ \textbf{rf}}^{-1} }_{#1} #3\xspace} 
\newcommand{\nrfinv}[3]{#2 \nrightarrow^{ \textcolor{PineGreen}{ \textbf{rf}}^{-1} }_{#1} #3\xspace}
...
\newcommand{\setWS}{\ws{\inv{\tau}}{}{}\xspace}
\newcommand{\nsetHB}{\nhb{\tau}{}{}\xspace}
\newcommand{\nsetMO}{\nmo{\tau}{}{}\xspace}
